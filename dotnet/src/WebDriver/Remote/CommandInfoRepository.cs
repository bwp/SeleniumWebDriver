...
namespace OpenQA.Selenium.Remote
{
    ...
    public class CommandInfoRepository
    {
        ...
        private void InitializeCommandDictionary()
        {
            ...
            //this.commandDictionary.Add(DriverCommand.AuthenticatedGet, new CommandInfo(CommandInfo.PostCommand, "/session/{sessionId}/url/username/password"));
            this.commandDictionary.Add(DriverCommand.AuthenticatedGet, new CommandInfo(CommandInfo.PostCommand, "/session/{sessionId}/url"));
