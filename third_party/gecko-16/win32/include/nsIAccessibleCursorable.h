/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/accessible/public/nsIAccessibleCursorable.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleCursorable : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IACCESSIBLECURSORABLE_IID)

  /* readonly attribute nsIAccessiblePivot virtualCursor; */
  NS_SCRIPTABLE NS_IMETHOD GetVirtualCursor(nsIAccessiblePivot * *aVirtualCursor) = 0;
...
#define NS_DECL_NSIACCESSIBLECURSORABLE \
  NS_SCRIPTABLE NS_IMETHOD GetVirtualCursor(nsIAccessiblePivot * *aVirtualCursor); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIACCESSIBLECURSORABLE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetVirtualCursor(nsIAccessiblePivot * *aVirtualCursor) { return _to GetVirtualCursor(aVirtualCursor); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIACCESSIBLECURSORABLE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetVirtualCursor(nsIAccessiblePivot * *aVirtualCursor) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetVirtualCursor(aVirtualCursor); } 
