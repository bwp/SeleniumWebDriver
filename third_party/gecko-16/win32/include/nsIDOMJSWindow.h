...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMJSWindow : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ClearTimeout(PRInt32 handle) = 0;

  /* void clearInterval ([optional] in long handle); */
  NS_SCRIPTABLE NS_IMETHOD ClearInterval(PRInt32 handle) = 0;
...
#define NS_DECL_NSIDOMJSWINDOW \
  ...
  NS_SCRIPTABLE NS_IMETHOD ClearTimeout(PRInt32 handle); \
  NS_SCRIPTABLE NS_IMETHOD ClearInterval(PRInt32 handle); \
...
#define NS_FORWARD_NSIDOMJSWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ClearTimeout(PRInt32 handle) { return _to ClearTimeout(handle); } \
  NS_SCRIPTABLE NS_IMETHOD ClearInterval(PRInt32 handle) { return _to ClearInterval(handle); } \
...
#define NS_FORWARD_SAFE_NSIDOMJSWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ClearTimeout(PRInt32 handle) { return !_to ? NS_ERROR_NULL_POINTER : _to->ClearTimeout(handle); } \
  NS_SCRIPTABLE NS_IMETHOD ClearInterval(PRInt32 handle) { return !_to ? NS_ERROR_NULL_POINTER : _to->ClearInterval(handle); } \
...
/* void clearTimeout ([optional] in long handle); */
NS_IMETHODIMP nsDOMJSWindow::ClearTimeout(PRInt32 handle)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void clearInterval ([optional] in long handle); */
NS_IMETHODIMP nsDOMJSWindow::ClearInterval(PRInt32 handle)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
