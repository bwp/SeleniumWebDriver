...
#define NS_IDOMHTMLDOCUMENT_IID_STR "ecae54c6-2ab9-4167-b0ef-61960aadbb68"

#define NS_IDOMHTMLDOCUMENT_IID \
  {0xecae54c6, 0x2ab9, 0x4167, \
    { 0xb0, 0xef, 0x61, 0x96, 0x0a, 0xad, 0xbb, 0x68 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLDocument : public nsIDOMDocument {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetItems(const nsAString & types, nsIDOMNodeList * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMHTMLDOCUMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetItems(const nsAString & types, nsIDOMNodeList * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOMHTMLDOCUMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetItems(const nsAString & types, nsIDOMNodeList * *_retval NS_OUTPARAM) { return _to GetItems(types, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMHTMLDOCUMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetItems(const nsAString & types, nsIDOMNodeList * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItems(types, _retval); } \
...
/* nsIDOMNodeList getItems ([optional] in DOMString types); */
NS_IMETHODIMP nsDOMHTMLDocument::GetItems(const nsAString & types, nsIDOMNodeList * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
