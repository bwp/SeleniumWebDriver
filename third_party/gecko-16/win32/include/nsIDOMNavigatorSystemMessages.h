/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/messages/interfaces/nsIDOMNavigatorSystemMessages.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSystemMessageCallback : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMSYSTEMMESSAGECALLBACK_IID)

  /* void handleMessage (in jsval message); */
  NS_SCRIPTABLE NS_IMETHOD HandleMessage(const JS::Value & message) = 0;
...
#define NS_DECL_NSIDOMSYSTEMMESSAGECALLBACK \
  NS_SCRIPTABLE NS_IMETHOD HandleMessage(const JS::Value & message); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSYSTEMMESSAGECALLBACK(_to) \
  NS_SCRIPTABLE NS_IMETHOD HandleMessage(const JS::Value & message) { return _to HandleMessage(message); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSYSTEMMESSAGECALLBACK(_to) \
  NS_SCRIPTABLE NS_IMETHOD HandleMessage(const JS::Value & message) { return !_to ? NS_ERROR_NULL_POINTER : _to->HandleMessage(message); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNavigatorSystemMessages : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD MozSetMessageHandler(const nsAString & type, nsIDOMSystemMessageCallback *callback) = 0;

  /* boolean mozHasPendingMessage (in DOMString type); */
  NS_SCRIPTABLE NS_IMETHOD MozHasPendingMessage(const nsAString & type, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMNAVIGATORSYSTEMMESSAGES \
  NS_SCRIPTABLE NS_IMETHOD MozSetMessageHandler(const nsAString & type, nsIDOMSystemMessageCallback *callback); \
  NS_SCRIPTABLE NS_IMETHOD MozHasPendingMessage(const nsAString & type, bool *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMNAVIGATORSYSTEMMESSAGES(_to) \
  NS_SCRIPTABLE NS_IMETHOD MozSetMessageHandler(const nsAString & type, nsIDOMSystemMessageCallback *callback) { return _to MozSetMessageHandler(type, callback); } \
  NS_SCRIPTABLE NS_IMETHOD MozHasPendingMessage(const nsAString & type, bool *_retval NS_OUTPARAM) { return _to MozHasPendingMessage(type, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMNAVIGATORSYSTEMMESSAGES(_to) \
  NS_SCRIPTABLE NS_IMETHOD MozSetMessageHandler(const nsAString & type, nsIDOMSystemMessageCallback *callback) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozSetMessageHandler(type, callback); } \
  NS_SCRIPTABLE NS_IMETHOD MozHasPendingMessage(const nsAString & type, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozHasPendingMessage(type, _retval); } 
...
/* boolean mozHasPendingMessage (in DOMString type); */
NS_IMETHODIMP nsDOMNavigatorSystemMessages::MozHasPendingMessage(const nsAString & type, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
