...
class NS_NO_VTABLE NS_SCRIPTABLE nsILocalFileWin : public nsILocalFile {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetShortcut(nsIFile *targetFile, nsIFile *workingDir, const PRUnichar * args, const PRUnichar * description, nsIFile *iconFile, PRInt32 iconIndex) = 0;
...
#define NS_DECL_NSILOCALFILEWIN \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetShortcut(nsIFile *targetFile, nsIFile *workingDir, const PRUnichar * args, const PRUnichar * description, nsIFile *iconFile, PRInt32 iconIndex); 
...
#define NS_FORWARD_NSILOCALFILEWIN(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetShortcut(nsIFile *targetFile, nsIFile *workingDir, const PRUnichar * args, const PRUnichar * description, nsIFile *iconFile, PRInt32 iconIndex) { return _to SetShortcut(targetFile, workingDir, args, description, iconFile, iconIndex); } 
...
#define NS_FORWARD_SAFE_NSILOCALFILEWIN(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetShortcut(nsIFile *targetFile, nsIFile *workingDir, const PRUnichar * args, const PRUnichar * description, nsIFile *iconFile, PRInt32 iconIndex) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetShortcut(targetFile, workingDir, args, description, iconFile, iconIndex); } 
...
/* void setShortcut ([optional] in nsIFile targetFile, [optional] in nsIFile workingDir, [optional] in wstring args, [optional] in wstring description, [optional] in nsIFile iconFile, [optional] in long iconIndex); */
NS_IMETHODIMP nsLocalFileWin::SetShortcut(nsIFile *targetFile, nsIFile *workingDir, const PRUnichar * args, const PRUnichar * description, nsIFile *iconFile, PRInt32 iconIndex)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
