...
class NS_NO_VTABLE NS_SCRIPTABLE nsIIDBObjectStore : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Clear(JSContext* cx, nsIIDBRequest * *_retval NS_OUTPARAM) = 0;

  /* [implicit_jscontext,optional_argc] nsIIDBRequest openCursor ([optional] in jsval range, [optional] in DOMString direction); */
  NS_SCRIPTABLE NS_IMETHOD OpenCursor(const JS::Value & range, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIIDBOBJECTSTORE \
  ...
  NS_SCRIPTABLE NS_IMETHOD Clear(JSContext* cx, nsIIDBRequest * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD OpenCursor(const JS::Value & range, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIIDBOBJECTSTORE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Clear(JSContext* cx, nsIIDBRequest * *_retval NS_OUTPARAM) { return _to Clear(cx, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD OpenCursor(const JS::Value & range, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM) { return _to OpenCursor(range, direction, cx, _argc, _retval); } \
...
#define NS_FORWARD_SAFE_NSIIDBOBJECTSTORE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Clear(JSContext* cx, nsIIDBRequest * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Clear(cx, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD OpenCursor(const JS::Value & range, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenCursor(range, direction, cx, _argc, _retval); } \
...
/* [implicit_jscontext] nsIIDBRequest clear (); */
NS_IMETHODIMP nsIDBObjectStore::Clear(JSContext* cx, nsIIDBRequest * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [implicit_jscontext,optional_argc] nsIIDBRequest openCursor ([optional] in jsval range, [optional] in DOMString direction); */
NS_IMETHODIMP nsIDBObjectStore::OpenCursor(const JS::Value & range, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
