...
class NS_NO_VTABLE NS_SCRIPTABLE mozIVisitedStatusCallback : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(MOZIVISITEDSTATUSCALLBACK_IID)

  /* void isVisited (in nsIURI aURI, in boolean aVisitedStatus); */
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, bool aVisitedStatus) = 0;
...
#define NS_DECL_MOZIVISITEDSTATUSCALLBACK \
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, bool aVisitedStatus); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_MOZIVISITEDSTATUSCALLBACK(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, bool aVisitedStatus) { return _to IsVisited(aURI, aVisitedStatus); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_MOZIVISITEDSTATUSCALLBACK(_to) \
  NS_SCRIPTABLE NS_IMETHOD IsVisited(nsIURI *aURI, bool aVisitedStatus) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsVisited(aURI, aVisitedStatus); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE mozIAsyncHistory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD IsURIVisited(nsIURI *aURI, mozIVisitedStatusCallback *aCallback) = 0;
...
#define NS_DECL_MOZIASYNCHISTORY \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsURIVisited(nsIURI *aURI, mozIVisitedStatusCallback *aCallback); 
...
#define NS_FORWARD_MOZIASYNCHISTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsURIVisited(nsIURI *aURI, mozIVisitedStatusCallback *aCallback) { return _to IsURIVisited(aURI, aCallback); } 
...
#define NS_FORWARD_SAFE_MOZIASYNCHISTORY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsURIVisited(nsIURI *aURI, mozIVisitedStatusCallback *aCallback) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsURIVisited(aURI, aCallback); } 
