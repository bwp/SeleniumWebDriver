...
class NS_NO_VTABLE NS_SCRIPTABLE nsIINIParserWriter : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFile(nsIFile *aINIFile, PRUint32 aFlags) = 0;
...
#define NS_DECL_NSIINIPARSERWRITER \
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFile(nsIFile *aINIFile, PRUint32 aFlags); 
...
#define NS_FORWARD_NSIINIPARSERWRITER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFile(nsIFile *aINIFile, PRUint32 aFlags) { return _to WriteFile(aINIFile, aFlags); } 
...
#define NS_FORWARD_SAFE_NSIINIPARSERWRITER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFile(nsIFile *aINIFile, PRUint32 aFlags) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteFile(aINIFile, aFlags); } 
...
/* void writeFile ([optional] in nsIFile aINIFile, [optional] in unsigned long aFlags); */
NS_IMETHODIMP nsINIParserWriter::WriteFile(nsIFile *aINIFile, PRUint32 aFlags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIINIParserFactory : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateINIParser(nsIFile *aINIFile, nsIINIParser * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIINIPARSERFACTORY \
  NS_SCRIPTABLE NS_IMETHOD CreateINIParser(nsIFile *aINIFile, nsIINIParser * *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIINIPARSERFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD CreateINIParser(nsIFile *aINIFile, nsIINIParser * *_retval NS_OUTPARAM) { return _to CreateINIParser(aINIFile, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIINIPARSERFACTORY(_to) \
  NS_SCRIPTABLE NS_IMETHOD CreateINIParser(nsIFile *aINIFile, nsIINIParser * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateINIParser(aINIFile, _retval); } 
...
/* nsIINIParser createINIParser (in nsIFile aINIFile); */
NS_IMETHODIMP nsINIParserFactory::CreateINIParser(nsIFile *aINIFile, nsIINIParser * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
