...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMElement : public nsIDOMNode {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollLeftMax(PRInt32 *aScrollLeftMax) = 0;

  /* readonly attribute long scrollTopMax; */
  NS_SCRIPTABLE NS_IMETHOD GetScrollTopMax(PRInt32 *aScrollTopMax) = 0;
...
#define NS_DECL_NSIDOMELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollLeftMax(PRInt32 *aScrollLeftMax); \
  NS_SCRIPTABLE NS_IMETHOD GetScrollTopMax(PRInt32 *aScrollTopMax); \
...
#define NS_FORWARD_NSIDOMELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollLeftMax(PRInt32 *aScrollLeftMax) { return _to GetScrollLeftMax(aScrollLeftMax); } \
  NS_SCRIPTABLE NS_IMETHOD GetScrollTopMax(PRInt32 *aScrollTopMax) { return _to GetScrollTopMax(aScrollTopMax); } \
...
#define NS_FORWARD_SAFE_NSIDOMELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScrollLeftMax(PRInt32 *aScrollLeftMax) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScrollLeftMax(aScrollLeftMax); } \
  NS_SCRIPTABLE NS_IMETHOD GetScrollTopMax(PRInt32 *aScrollTopMax) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScrollTopMax(aScrollTopMax); } \
...
/* readonly attribute long scrollLeftMax; */
NS_IMETHODIMP nsDOMElement::GetScrollLeftMax(PRInt32 *aScrollLeftMax)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute long scrollTopMax; */
NS_IMETHODIMP nsDOMElement::GetScrollTopMax(PRInt32 *aScrollTopMax)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
