/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/js/xpconnect/idl/nsIScriptError.idl
 */
...
#define NS_ISCRIPTERROR_IID_STR "c6dd877a-87b6-47cc-968d-90f4514ec65f"

#define NS_ISCRIPTERROR_IID \
  {0xc6dd877a, 0x87b6, 0x47cc, \
    { 0x96, 0x8d, 0x90, 0xf4, 0x51, 0x4e, 0xc6, 0x5f }}
...
/* readonly attribute unsigned long long outerWindowID; */
NS_IMETHODIMP nsScriptError::GetOuterWindowID(PRUint64 *aOuterWindowID)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute unsigned long long innerWindowID; */
NS_IMETHODIMP nsScriptError::GetInnerWindowID(PRUint64 *aInnerWindowID)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void initWithWindowID (in wstring message, in wstring sourceName, in wstring sourceLine, in PRUint32 lineNumber, in PRUint32 columnNumber, in PRUint32 flags, in string category, in unsigned long long innerWindowID); */
NS_IMETHODIMP nsScriptError::InitWithWindowID(const PRUnichar * message, const PRUnichar * sourceName, const PRUnichar * sourceLine, PRUint32 lineNumber, PRUint32 columnNumber, PRUint32 flags, const char * category, PRUint64 innerWindowID)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
