...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNavigator : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Vibrate(const JS::Value & aPattern, JSContext* cx) = 0;

  /* void addIdleObserver (in nsIIdleObserver aIdleObserver); */
  NS_SCRIPTABLE NS_IMETHOD AddIdleObserver(nsIIdleObserver *aIdleObserver) = 0;

  /* void removeIdleObserver (in nsIIdleObserver aIdleObserver); */
  NS_SCRIPTABLE NS_IMETHOD RemoveIdleObserver(nsIIdleObserver *aIdleObserver) = 0;
...
#define NS_DECL_NSIDOMNAVIGATOR \
  ...
  NS_SCRIPTABLE NS_IMETHOD Vibrate(const JS::Value & aPattern, JSContext* cx); \
  NS_SCRIPTABLE NS_IMETHOD AddIdleObserver(nsIIdleObserver *aIdleObserver); \
  NS_SCRIPTABLE NS_IMETHOD RemoveIdleObserver(nsIIdleObserver *aIdleObserver); \
...
#define NS_FORWARD_NSIDOMNAVIGATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Vibrate(const JS::Value & aPattern, JSContext* cx) { return _to Vibrate(aPattern, cx); } \
  NS_SCRIPTABLE NS_IMETHOD AddIdleObserver(nsIIdleObserver *aIdleObserver) { return _to AddIdleObserver(aIdleObserver); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveIdleObserver(nsIIdleObserver *aIdleObserver) { return _to RemoveIdleObserver(aIdleObserver); } \
...
#define NS_FORWARD_SAFE_NSIDOMNAVIGATOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Vibrate(const JS::Value & aPattern, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->Vibrate(aPattern, cx); } \
  NS_SCRIPTABLE NS_IMETHOD AddIdleObserver(nsIIdleObserver *aIdleObserver) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddIdleObserver(aIdleObserver); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveIdleObserver(nsIIdleObserver *aIdleObserver) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveIdleObserver(aIdleObserver); } \
