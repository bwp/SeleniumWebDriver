...
class NS_NO_VTABLE NS_SCRIPTABLE nsILoginManagerCrypto : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDefaultEncType(PRUint32 *aDefaultEncType) = 0;
...
#define NS_DECL_NSILOGINMANAGERCRYPTO \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDefaultEncType(PRUint32 *aDefaultEncType); 
...
#define NS_FORWARD_NSILOGINMANAGERCRYPTO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDefaultEncType(PRUint32 *aDefaultEncType) { return _to GetDefaultEncType(aDefaultEncType); } 
...
#define NS_FORWARD_SAFE_NSILOGINMANAGERCRYPTO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDefaultEncType(PRUint32 *aDefaultEncType) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDefaultEncType(aDefaultEncType); } 
...
/* readonly attribute unsigned long defaultEncType; */
NS_IMETHODIMP nsLoginManagerCrypto::GetDefaultEncType(PRUint32 *aDefaultEncType)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
