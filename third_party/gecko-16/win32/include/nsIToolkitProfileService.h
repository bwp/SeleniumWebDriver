...
class NS_NO_VTABLE NS_SCRIPTABLE nsIToolkitProfileService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD LockProfilePath(nsIFile *aDirectory, nsIFile *aTempDirectory, nsIProfileLock * *_retval NS_OUTPARAM) = 0;

  /* nsIToolkitProfile createProfile (in nsIFile aRootDir, in nsIFile aTempDir, in AUTF8String aName); */
  NS_SCRIPTABLE NS_IMETHOD CreateProfile(nsIFile *aRootDir, nsIFile *aTempDir, const nsACString & aName, nsIToolkitProfile * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSITOOLKITPROFILESERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD LockProfilePath(nsIFile *aDirectory, nsIFile *aTempDirectory, nsIProfileLock * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD CreateProfile(nsIFile *aRootDir, nsIFile *aTempDir, const nsACString & aName, nsIToolkitProfile * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSITOOLKITPROFILESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD LockProfilePath(nsIFile *aDirectory, nsIFile *aTempDirectory, nsIProfileLock * *_retval NS_OUTPARAM) { return _to LockProfilePath(aDirectory, aTempDirectory, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateProfile(nsIFile *aRootDir, nsIFile *aTempDir, const nsACString & aName, nsIToolkitProfile * *_retval NS_OUTPARAM) { return _to CreateProfile(aRootDir, aTempDir, aName, _retval); } \
...
#define NS_FORWARD_SAFE_NSITOOLKITPROFILESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD LockProfilePath(nsIFile *aDirectory, nsIFile *aTempDirectory, nsIProfileLock * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->LockProfilePath(aDirectory, aTempDirectory, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD CreateProfile(nsIFile *aRootDir, nsIFile *aTempDir, const nsACString & aName, nsIToolkitProfile * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateProfile(aRootDir, aTempDir, aName, _retval); } \
...
/* nsIProfileLock lockProfilePath (in nsIFile aDirectory, in nsIFile aTempDirectory); */
NS_IMETHODIMP nsToolkitProfileService::LockProfilePath(nsIFile *aDirectory, nsIFile *aTempDirectory, nsIProfileLock * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIToolkitProfile createProfile (in nsIFile aRootDir, in nsIFile aTempDir, in AUTF8String aName); */
NS_IMETHODIMP nsToolkitProfileService::CreateProfile(nsIFile *aRootDir, nsIFile *aTempDir, const nsACString & aName, nsIToolkitProfile * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
