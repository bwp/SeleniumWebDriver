...
class NS_NO_VTABLE NS_SCRIPTABLE nsIProfileLock : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalDirectory(nsIFile * *aLocalDirectory) = 0;
...
#define NS_DECL_NSIPROFILELOCK \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalDirectory(nsIFile * *aLocalDirectory); \
...
#define NS_FORWARD_NSIPROFILELOCK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalDirectory(nsIFile * *aLocalDirectory) { return _to GetLocalDirectory(aLocalDirectory); } \
...
#define NS_FORWARD_SAFE_NSIPROFILELOCK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLocalDirectory(nsIFile * *aLocalDirectory) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLocalDirectory(aLocalDirectory); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIToolkitProfile : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRootDir(nsIFile * *aRootDir) = 0;

  /* readonly attribute nsIFile localDir; */
  NS_SCRIPTABLE NS_IMETHOD GetLocalDir(nsIFile * *aLocalDir) = 0;
...
#define NS_DECL_NSITOOLKITPROFILE \
  NS_SCRIPTABLE NS_IMETHOD GetRootDir(nsIFile * *aRootDir); \
  NS_SCRIPTABLE NS_IMETHOD GetLocalDir(nsIFile * *aLocalDir); \
...
#define NS_FORWARD_NSITOOLKITPROFILE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetRootDir(nsIFile * *aRootDir) { return _to GetRootDir(aRootDir); } \
  NS_SCRIPTABLE NS_IMETHOD GetLocalDir(nsIFile * *aLocalDir) { return _to GetLocalDir(aLocalDir); } \
...
#define NS_FORWARD_SAFE_NSITOOLKITPROFILE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetRootDir(nsIFile * *aRootDir) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRootDir(aRootDir); } \
  NS_SCRIPTABLE NS_IMETHOD GetLocalDir(nsIFile * *aLocalDir) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLocalDir(aLocalDir); } \
