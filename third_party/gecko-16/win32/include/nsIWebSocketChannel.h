...
class NS_NO_VTABLE nsIWebSocketChannel : public nsISupports {
 public: 
  ...
  NS_IMETHOD Close(PRUint16 aCode, const nsACString & aReason) = 0;
  ...
  NS_IMETHOD SendBinaryStream(nsIInputStream *aStream, PRUint32 length) = 0;
...
#define NS_FORWARD_NSIWEBSOCKETCHANNEL(_to) \
  ...
  NS_IMETHOD Close(PRUint16 aCode, const nsACString & aReason) { return _to Close(aCode, aReason); } \
  ...
  NS_IMETHOD SendBinaryStream(nsIInputStream *aStream, PRUint32 length) { return _to SendBinaryStream(aStream, length); } 
...
#define NS_FORWARD_SAFE_NSIWEBSOCKETCHANNEL(_to) \
  ...
  NS_IMETHOD Close(PRUint16 aCode, const nsACString & aReason) { return !_to ? NS_ERROR_NULL_POINTER : _to->Close(aCode, aReason); } \
  ...
  NS_IMETHOD SendBinaryStream(nsIInputStream *aStream, PRUint32 length) { return !_to ? NS_ERROR_NULL_POINTER : _to->SendBinaryStream(aStream, length); } 
...
/* void sendBinaryStream (in nsIInputStream aStream, in unsigned long length); */
NS_IMETHODIMP nsWebSocketChannel::SendBinaryStream(nsIInputStream *aStream, PRUint32 length)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
