...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBrowserSearchInitObserver : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IBROWSERSEARCHINITOBSERVER_IID)

  /* void onInitComplete (in nsresult aStatus); */
  NS_SCRIPTABLE NS_IMETHOD OnInitComplete(nsresult aStatus) = 0;
...
#define NS_DECL_NSIBROWSERSEARCHINITOBSERVER \
  NS_SCRIPTABLE NS_IMETHOD OnInitComplete(nsresult aStatus); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIBROWSERSEARCHINITOBSERVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnInitComplete(nsresult aStatus) { return _to OnInitComplete(aStatus); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIBROWSERSEARCHINITOBSERVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnInitComplete(nsresult aStatus) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnInitComplete(aStatus); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIBrowserSearchService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIBrowserSearchInitObserver *aObserver) = 0;
...
#define NS_DECL_NSIBROWSERSEARCHSERVICE \
  NS_SCRIPTABLE NS_IMETHOD Init(nsIBrowserSearchInitObserver *aObserver); \
...
#define NS_FORWARD_NSIBROWSERSEARCHSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Init(nsIBrowserSearchInitObserver *aObserver) { return _to Init(aObserver); } \
...
#define NS_FORWARD_SAFE_NSIBROWSERSEARCHSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Init(nsIBrowserSearchInitObserver *aObserver) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aObserver); } \
