...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompleteResult : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTypeAheadResult(bool *aTypeAheadResult) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETERESULT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTypeAheadResult(bool *aTypeAheadResult); \
...
#define NS_FORWARD_NSIAUTOCOMPLETERESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTypeAheadResult(bool *aTypeAheadResult) { return _to GetTypeAheadResult(aTypeAheadResult); } \
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETERESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTypeAheadResult(bool *aTypeAheadResult) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTypeAheadResult(aTypeAheadResult); } \
