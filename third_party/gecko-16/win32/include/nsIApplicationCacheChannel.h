...
class NS_NO_VTABLE NS_SCRIPTABLE nsIApplicationCacheChannel : public nsIApplicationCacheContainer {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApplicationCacheForWrite(nsIApplicationCache * *aApplicationCacheForWrite) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetApplicationCacheForWrite(nsIApplicationCache *aApplicationCacheForWrite) = 0;
...
#define NS_DECL_NSIAPPLICATIONCACHECHANNEL \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApplicationCacheForWrite(nsIApplicationCache * *aApplicationCacheForWrite); \
  NS_SCRIPTABLE NS_IMETHOD SetApplicationCacheForWrite(nsIApplicationCache *aApplicationCacheForWrite); 
...
#define NS_FORWARD_NSIAPPLICATIONCACHECHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApplicationCacheForWrite(nsIApplicationCache * *aApplicationCacheForWrite) { return _to GetApplicationCacheForWrite(aApplicationCacheForWrite); } \
  NS_SCRIPTABLE NS_IMETHOD SetApplicationCacheForWrite(nsIApplicationCache *aApplicationCacheForWrite) { return _to SetApplicationCacheForWrite(aApplicationCacheForWrite); } 
...
#define NS_FORWARD_SAFE_NSIAPPLICATIONCACHECHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApplicationCacheForWrite(nsIApplicationCache * *aApplicationCacheForWrite) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetApplicationCacheForWrite(aApplicationCacheForWrite); } \
  NS_SCRIPTABLE NS_IMETHOD SetApplicationCacheForWrite(nsIApplicationCache *aApplicationCacheForWrite) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetApplicationCacheForWrite(aApplicationCacheForWrite); } 
