...
class NS_NO_VTABLE NS_SCRIPTABLE nsICacheListener : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnCacheEntryDoomed(nsresult status) = 0;
...
#define NS_DECL_NSICACHELISTENER \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnCacheEntryDoomed(nsresult status); 
...
#define NS_FORWARD_NSICACHELISTENER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnCacheEntryDoomed(nsresult status) { return _to OnCacheEntryDoomed(status); } 
...
#define NS_FORWARD_SAFE_NSICACHELISTENER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnCacheEntryDoomed(nsresult status) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnCacheEntryDoomed(status); } 
