...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMStorageIndexedDB : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIndexedDB(nsIIDBFactory * *aIndexedDB) = 0;
...
#define NS_DECL_NSIDOMSTORAGEINDEXEDDB \
  NS_SCRIPTABLE NS_IMETHOD GetIndexedDB(nsIIDBFactory * *aIndexedDB); \
...
#define NS_FORWARD_NSIDOMSTORAGEINDEXEDDB(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIndexedDB(nsIIDBFactory * *aIndexedDB) { return _to GetIndexedDB(aIndexedDB); } \
...
#define NS_FORWARD_SAFE_NSIDOMSTORAGEINDEXEDDB(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetIndexedDB(nsIIDBFactory * *aIndexedDB) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIndexedDB(aIndexedDB); } \
