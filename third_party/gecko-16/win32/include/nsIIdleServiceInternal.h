/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/nsIIdleServiceInternal.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIIdleServiceInternal : public nsIIdleService {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IIDLESERVICEINTERNAL_IID)

  /* void resetIdleTimeOut (in unsigned long idleDeltaInMS); */
  NS_SCRIPTABLE NS_IMETHOD ResetIdleTimeOut(PRUint32 idleDeltaInMS) = 0;
...
#define NS_DECL_NSIIDLESERVICEINTERNAL \
  NS_SCRIPTABLE NS_IMETHOD ResetIdleTimeOut(PRUint32 idleDeltaInMS); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIIDLESERVICEINTERNAL(_to) \
  NS_SCRIPTABLE NS_IMETHOD ResetIdleTimeOut(PRUint32 idleDeltaInMS) { return _to ResetIdleTimeOut(idleDeltaInMS); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIIDLESERVICEINTERNAL(_to) \
  NS_SCRIPTABLE NS_IMETHOD ResetIdleTimeOut(PRUint32 idleDeltaInMS) { return !_to ? NS_ERROR_NULL_POINTER : _to->ResetIdleTimeOut(idleDeltaInMS); } 
...
/* void resetIdleTimeOut (in unsigned long idleDeltaInMS); */
NS_IMETHODIMP nsIdleServiceInternal::ResetIdleTimeOut(PRUint32 idleDeltaInMS)
{
