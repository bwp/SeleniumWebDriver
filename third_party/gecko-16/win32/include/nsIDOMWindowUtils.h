...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMWindowUtils : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SendSimpleGestureEvent(const nsAString & aType, float aX, float aY, PRUint32 aDirection, double aDelta, PRInt32 aModifiers, PRUint32 aClickCount) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApp(mozIDOMApplication * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMWINDOWUTILS \
  ...
  NS_SCRIPTABLE NS_IMETHOD SendSimpleGestureEvent(const nsAString & aType, float aX, float aY, PRUint32 aDirection, double aDelta, PRInt32 aModifiers, PRUint32 aClickCount); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApp(mozIDOMApplication * *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIDOMWINDOWUTILS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SendSimpleGestureEvent(const nsAString & aType, float aX, float aY, PRUint32 aDirection, double aDelta, PRInt32 aModifiers, PRUint32 aClickCount) { return _to SendSimpleGestureEvent(aType, aX, aY, aDirection, aDelta, aModifiers, aClickCount); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApp(mozIDOMApplication * *_retval NS_OUTPARAM) { return _to GetApp(_retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMWINDOWUTILS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SendSimpleGestureEvent(const nsAString & aType, float aX, float aY, PRUint32 aDirection, double aDelta, PRInt32 aModifiers, PRUint32 aClickCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->SendSimpleGestureEvent(aType, aX, aY, aDirection, aDelta, aModifiers, aClickCount); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetApp(mozIDOMApplication * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetApp(_retval); } 
...
/* void sendSimpleGestureEvent (in AString aType, in float aX, in float aY, in unsigned long aDirection, in double aDelta, in long aModifiers, [optional] in unsigned long aClickCount); */
NS_IMETHODIMP nsDOMWindowUtils::SendSimpleGestureEvent(const nsAString & aType, float aX, float aY, PRUint32 aDirection, double aDelta, PRInt32 aModifiers, PRUint32 aClickCount)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* mozIDOMApplication getApp (); */
NS_IMETHODIMP nsDOMWindowUtils::GetApp(mozIDOMApplication * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
