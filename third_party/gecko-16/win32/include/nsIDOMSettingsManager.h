...
#define NS_IDOMSETTINGSMANAGER_IID_STR "dd9f5380-a454-11e1-b3dd-0800200c9a66"

#define NS_IDOMSETTINGSMANAGER_IID \
  {0xdd9f5380, 0xa454, 0x11e1, \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSettingsManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(const nsAString & name, const JS::Value & callback) = 0;

  /* void removeObserver (in DOMString name, in jsval callback); */
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(const nsAString & name, const JS::Value & callback) = 0;
...
#define NS_DECL_NSIDOMSETTINGSMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(const nsAString & name, const JS::Value & callback); \
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(const nsAString & name, const JS::Value & callback); \
...
#define NS_FORWARD_NSIDOMSETTINGSMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(const nsAString & name, const JS::Value & callback) { return _to AddObserver(name, callback); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(const nsAString & name, const JS::Value & callback) { return _to RemoveObserver(name, callback); } \
...
#define NS_FORWARD_SAFE_NSIDOMSETTINGSMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddObserver(const nsAString & name, const JS::Value & callback) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddObserver(name, callback); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveObserver(const nsAString & name, const JS::Value & callback) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveObserver(name, callback); } \
...
#define NS_IDOMMOZSETTINGSEVENT_IID_STR "5e304193-af49-4546-8329-bf7c9159ed98"

#define NS_IDOMMOZSETTINGSEVENT_IID \
  {0x5e304193, 0xaf49, 0x4546, \
    { 0x83, 0x29, 0xbf, 0x7c, 0x91, 0x59, 0xed, 0x98 }}
