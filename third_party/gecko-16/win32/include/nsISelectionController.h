...
class NS_NO_VTABLE NS_SCRIPTABLE nsISelectionController : public nsISelectionDisplay {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ScrollCharacter(bool right) = 0;
  ...
  virtual nsresult CheckVisibilityContent(nsIContent *node, PRInt16 startOffset, PRInt16 endOffset, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISELECTIONCONTROLLER \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScrollCharacter(bool right); \
  ...
  virtual nsresult CheckVisibilityContent(nsIContent *node, PRInt16 startOffset, PRInt16 endOffset, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSISELECTIONCONTROLLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScrollCharacter(bool right) { return _to ScrollCharacter(right); } \
  ...
  virtual nsresult CheckVisibilityContent(nsIContent *node, PRInt16 startOffset, PRInt16 endOffset, bool *_retval NS_OUTPARAM) { return _to CheckVisibilityContent(node, startOffset, endOffset, _retval); } 
...
#define NS_FORWARD_SAFE_NSISELECTIONCONTROLLER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScrollCharacter(bool right) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollCharacter(right); } \
  ...
  virtual nsresult CheckVisibilityContent(nsIContent *node, PRInt16 startOffset, PRInt16 endOffset, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckVisibilityContent(node, startOffset, endOffset, _retval); } 
...
/* [noscript,nostdcall] boolean checkVisibilityContent (in nsIContent node, in short startOffset, in short endOffset); */
nsresult nsSelectionController::CheckVisibilityContent(nsIContent *node, PRInt16 startOffset, PRInt16 endOffset, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
