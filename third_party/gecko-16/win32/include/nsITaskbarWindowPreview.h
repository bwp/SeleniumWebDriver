/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/nsITaskbarWindowPreview.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITaskbarWindowPreview : public nsITaskbarPreview {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableCustomDrawing(bool *aEnableCustomDrawing) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetEnableCustomDrawing(bool aEnableCustomDrawing) = 0;
...
#define NS_DECL_NSITASKBARWINDOWPREVIEW \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableCustomDrawing(bool *aEnableCustomDrawing); \
  NS_SCRIPTABLE NS_IMETHOD SetEnableCustomDrawing(bool aEnableCustomDrawing); 
...
#define NS_FORWARD_NSITASKBARWINDOWPREVIEW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableCustomDrawing(bool *aEnableCustomDrawing) { return _to GetEnableCustomDrawing(aEnableCustomDrawing); } \
  NS_SCRIPTABLE NS_IMETHOD SetEnableCustomDrawing(bool aEnableCustomDrawing) { return _to SetEnableCustomDrawing(aEnableCustomDrawing); } 
...
#define NS_FORWARD_SAFE_NSITASKBARWINDOWPREVIEW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetEnableCustomDrawing(bool *aEnableCustomDrawing) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnableCustomDrawing(aEnableCustomDrawing); } \
  NS_SCRIPTABLE NS_IMETHOD SetEnableCustomDrawing(bool aEnableCustomDrawing) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetEnableCustomDrawing(aEnableCustomDrawing); } 
