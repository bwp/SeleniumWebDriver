...
namespace XMLHttpRequestUploadBinding {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal, JSObject* aReceiver)
  {
    ...
    JSObject* cachedObject = protoOrIfaceArray[prototypes::id::XMLHttpRequestUpload];
    if (!cachedObject) {
      protoOrIfaceArray[prototypes::id::XMLHttpRequestUpload] = cachedObject = CreateInterfaceObjects(aCx, aGlobal, aReceiver);
    }
  ...
  JSObject* Wrap(JSContext* aCx, JSObject* aScope, nsXMLHttpRequestUpload* aObject, bool* aTriedToWrap);
...
namespace XMLHttpRequestUploadBinding_workers {
  ...
  inline JSObject* GetProtoObject(JSContext* aCx, JSObject* aGlobal, JSObject* aReceiver)
  {
    ...
    /* Check to see whether the interface objects are already installed */
    JSObject** protoOrIfaceArray = GetProtoOrIfaceArray(aGlobal);
    JSObject* cachedObject = protoOrIfaceArray[prototypes::id::XMLHttpRequestUpload_workers];
    if (!cachedObject) {
      protoOrIfaceArray[prototypes::id::XMLHttpRequestUpload_workers] = cachedObject = CreateInterfaceObjects(aCx, aGlobal, aReceiver);
    }
  ...
  JSObject* Wrap(JSContext* aCx, JSObject* aScope, mozilla::dom::workers::XMLHttpRequestUpload* aObject, bool* aTriedToWrap);
