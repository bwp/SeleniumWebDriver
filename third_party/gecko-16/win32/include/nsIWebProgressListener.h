...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWebProgressListener : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnLocationChange(nsIWebProgress *aWebProgress, nsIRequest *aRequest, nsIURI *aLocation, PRUint32 aFlags) = 0;
...
#define NS_DECL_NSIWEBPROGRESSLISTENER \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnLocationChange(nsIWebProgress *aWebProgress, nsIRequest *aRequest, nsIURI *aLocation, PRUint32 aFlags); \
...
#define NS_FORWARD_NSIWEBPROGRESSLISTENER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnLocationChange(nsIWebProgress *aWebProgress, nsIRequest *aRequest, nsIURI *aLocation, PRUint32 aFlags) { return _to OnLocationChange(aWebProgress, aRequest, aLocation, aFlags); } \
...
#define NS_FORWARD_SAFE_NSIWEBPROGRESSLISTENER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnLocationChange(nsIWebProgress *aWebProgress, nsIRequest *aRequest, nsIURI *aLocation, PRUint32 aFlags) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnLocationChange(aWebProgress, aRequest, aLocation, aFlags); } \
...
/* void onLocationChange (in nsIWebProgress aWebProgress, in nsIRequest aRequest, in nsIURI aLocation, [optional] in unsigned long aFlags); */
NS_IMETHODIMP nsWebProgressListener::OnLocationChange(nsIWebProgress *aWebProgress, nsIRequest *aRequest, nsIURI *aLocation, PRUint32 aFlags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
