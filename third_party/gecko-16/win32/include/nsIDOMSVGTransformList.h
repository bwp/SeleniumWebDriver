...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGTransformList : public nsISupports {
 public: 
  ...
  /* [getter,noscript,nostdcall,notxpcom] nsIDOMSVGTransform getItemAt (in unsigned long index); */
  virtual nsIDOMSVGTransform * GetItemAt(PRUint32 index) = 0;
...
#define NS_DECL_NSIDOMSVGTRANSFORMLIST \
  ...
  virtual nsIDOMSVGTransform * GetItemAt(PRUint32 index); \
...
#define NS_FORWARD_NSIDOMSVGTRANSFORMLIST(_to) \
  ...
  virtual nsIDOMSVGTransform * GetItemAt(PRUint32 index) { return _to GetItemAt(index); } \
...
#define NS_FORWARD_SAFE_NSIDOMSVGTRANSFORMLIST(_to) \
  ...
  virtual nsIDOMSVGTransform * GetItemAt(PRUint32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItemAt(index); } \
...
/* [getter,noscript,nostdcall,notxpcom] nsIDOMSVGTransform getItemAt (in unsigned long index); */
nsIDOMSVGTransform * nsDOMSVGTransformList::GetItemAt(PRUint32 index)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
