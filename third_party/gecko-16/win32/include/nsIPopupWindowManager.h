...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPopupWindowManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIPrincipal *principal, PRUint32 *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIPOPUPWINDOWMANAGER \
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIPrincipal *principal, PRUint32 *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPOPUPWINDOWMANAGER(_to) \
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIPrincipal *principal, PRUint32 *_retval NS_OUTPARAM) { return _to TestPermission(principal, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPOPUPWINDOWMANAGER(_to) \
  NS_SCRIPTABLE NS_IMETHOD TestPermission(nsIPrincipal *principal, PRUint32 *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->TestPermission(principal, _retval); } 
...
/* PRUint32 testPermission (in nsIPrincipal principal); */
NS_IMETHODIMP nsPopupWindowManager::TestPermission(nsIPrincipal *principal, PRUint32 *_retval NS_OUTPARAM)
{
