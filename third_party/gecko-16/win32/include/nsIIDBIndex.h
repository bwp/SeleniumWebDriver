...
class NS_NO_VTABLE NS_SCRIPTABLE nsIIDBIndex : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OpenCursor(const JS::Value & key, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM) = 0;

  /* [implicit_jscontext,optional_argc] nsIIDBRequest openKeyCursor ([optional] in jsval key, [optional] in DOMString direction); */
  NS_SCRIPTABLE NS_IMETHOD OpenKeyCursor(const JS::Value & key, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIIDBINDEX \
  ...
  NS_SCRIPTABLE NS_IMETHOD OpenCursor(const JS::Value & key, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD OpenKeyCursor(const JS::Value & key, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIIDBINDEX(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OpenCursor(const JS::Value & key, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM) { return _to OpenCursor(key, direction, cx, _argc, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD OpenKeyCursor(const JS::Value & key, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM) { return _to OpenKeyCursor(key, direction, cx, _argc, _retval); } \
...
#define NS_FORWARD_SAFE_NSIIDBINDEX(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OpenCursor(const JS::Value & key, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenCursor(key, direction, cx, _argc, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD OpenKeyCursor(const JS::Value & key, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->OpenKeyCursor(key, direction, cx, _argc, _retval); } \
...
/* [implicit_jscontext,optional_argc] nsIIDBRequest openCursor ([optional] in jsval key, [optional] in DOMString direction); */
NS_IMETHODIMP nsIDBIndex::OpenCursor(const JS::Value & key, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [implicit_jscontext,optional_argc] nsIIDBRequest openKeyCursor ([optional] in jsval key, [optional] in DOMString direction); */
NS_IMETHODIMP nsIDBIndex::OpenKeyCursor(const JS::Value & key, const nsAString & direction, JSContext* cx, PRUint8 _argc, nsIIDBRequest * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
