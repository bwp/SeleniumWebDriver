...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompleteSimpleResult : public nsIAutoCompleteResult {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetTypeAheadResult(bool aHidden) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETESIMPLERESULT \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetTypeAheadResult(bool aHidden); \
...
#define NS_FORWARD_NSIAUTOCOMPLETESIMPLERESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetTypeAheadResult(bool aHidden) { return _to SetTypeAheadResult(aHidden); } \
...
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETESIMPLERESULT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetTypeAheadResult(bool aHidden) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTypeAheadResult(aHidden); } \
