...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMPaintRequestList : public nsISupports {
 public: 
  ...
  /* [forward(getItemAt),getter] nsIDOMPaintRequest item (in unsigned long index); */
  NS_SCRIPTABLE NS_IMETHOD Item(PRUint32 index, nsIDOMPaintRequest * *_retval NS_OUTPARAM) = 0;

  /* [noscript,nostdcall,notxpcom] nsIDOMPaintRequest getItemAt (in unsigned long index); */
  virtual nsIDOMPaintRequest * GetItemAt(PRUint32 index) = 0;
...
#define NS_DECL_NSIDOMPAINTREQUESTLIST \
  ...
  virtual nsIDOMPaintRequest * GetItemAt(PRUint32 index); 
...
#define NS_FORWARD_NSIDOMPAINTREQUESTLIST(_to) \
  ...
  virtual nsIDOMPaintRequest * GetItemAt(PRUint32 index) { return _to GetItemAt(index); } 
...
#define NS_FORWARD_SAFE_NSIDOMPAINTREQUESTLIST(_to) \
  ...
  virtual nsIDOMPaintRequest * GetItemAt(PRUint32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItemAt(index); } 
...
/* [noscript,nostdcall,notxpcom] nsIDOMPaintRequest getItemAt (in unsigned long index); */
nsIDOMPaintRequest * nsDOMPaintRequestList::GetItemAt(PRUint32 index)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
