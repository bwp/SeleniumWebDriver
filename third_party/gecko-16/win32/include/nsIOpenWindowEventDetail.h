/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/browser-element/nsIOpenWindowEventDetail.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIOpenWindowEventDetail : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFeatures(nsAString & aFeatures) = 0;

  /* readonly attribute nsIDOMNode frameElement; */
  NS_SCRIPTABLE NS_IMETHOD GetFrameElement(nsIDOMNode * *aFrameElement) = 0;
...
#define NS_DECL_NSIOPENWINDOWEVENTDETAIL \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFeatures(nsAString & aFeatures); \
  NS_SCRIPTABLE NS_IMETHOD GetFrameElement(nsIDOMNode * *aFrameElement); 
...
#define NS_FORWARD_NSIOPENWINDOWEVENTDETAIL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFeatures(nsAString & aFeatures) { return _to GetFeatures(aFeatures); } \
  NS_SCRIPTABLE NS_IMETHOD GetFrameElement(nsIDOMNode * *aFrameElement) { return _to GetFrameElement(aFrameElement); } 
...
#define NS_FORWARD_SAFE_NSIOPENWINDOWEVENTDETAIL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetFeatures(nsAString & aFeatures) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFeatures(aFeatures); } \
  NS_SCRIPTABLE NS_IMETHOD GetFrameElement(nsIDOMNode * *aFrameElement) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetFrameElement(aFrameElement); } 
