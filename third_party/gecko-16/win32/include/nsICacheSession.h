...
class NS_NO_VTABLE NS_SCRIPTABLE nsICacheSession : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetProfileDirectory(nsIFile *aProfileDirectory) = 0;
...
#define NS_DECL_NSICACHESESSION \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetProfileDirectory(nsIFile *aProfileDirectory); \
...
#define NS_FORWARD_NSICACHESESSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetProfileDirectory(nsIFile *aProfileDirectory) { return _to SetProfileDirectory(aProfileDirectory); } \
...
#define NS_FORWARD_SAFE_NSICACHESESSION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetProfileDirectory(nsIFile *aProfileDirectory) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetProfileDirectory(aProfileDirectory); } \
