...
class NS_NO_VTABLE NS_SCRIPTABLE nsICacheEntryDescriptor : public nsICacheEntryInfo {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStorageDataSize(PRUint32 *aStorageDataSize) = 0;
...
#define NS_DECL_NSICACHEENTRYDESCRIPTOR \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStorageDataSize(PRUint32 *aStorageDataSize); \
...
#define NS_FORWARD_NSICACHEENTRYDESCRIPTOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStorageDataSize(PRUint32 *aStorageDataSize) { return _to GetStorageDataSize(aStorageDataSize); } \
...
#define NS_FORWARD_SAFE_NSICACHEENTRYDESCRIPTOR(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStorageDataSize(PRUint32 *aStorageDataSize) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStorageDataSize(aStorageDataSize); } \
...
/* readonly attribute unsigned long storageDataSize; */
NS_IMETHODIMP nsCacheEntryDescriptor::GetStorageDataSize(PRUint32 *aStorageDataSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
