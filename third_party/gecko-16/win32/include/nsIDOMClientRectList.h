...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMClientRectList : public nsISupports {
 public: 
  ...
  virtual nsIDOMClientRect * GetItemAt(PRUint32 index) = 0;
...
#define NS_DECL_NSIDOMCLIENTRECTLIST \
  ...
  virtual nsIDOMClientRect * GetItemAt(PRUint32 index); 
...
#define NS_FORWARD_NSIDOMCLIENTRECTLIST(_to) \
  ...
  virtual nsIDOMClientRect * GetItemAt(PRUint32 index) { return _to GetItemAt(index); } 
...
#define NS_FORWARD_SAFE_NSIDOMCLIENTRECTLIST(_to) \
  ...
  virtual nsIDOMClientRect * GetItemAt(PRUint32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItemAt(index); } 
...
/* [noscript,nostdcall,notxpcom] nsIDOMClientRect getItemAt (in unsigned long index); */
nsIDOMClientRect * nsDOMClientRectList::GetItemAt(PRUint32 index)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
