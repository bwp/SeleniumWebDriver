...
class NS_NO_VTABLE NS_SCRIPTABLE nsIProfiler : public nsISupports {
 public: 
  ...
  /* void StartProfiler (in PRUint32 aEntries, in PRUint32 aInterval, [array, size_is (aFeatureCount)] in string aFeatures, in PRUint32 aFeatureCount); */
  NS_SCRIPTABLE NS_IMETHOD StartProfiler(PRUint32 aEntries, PRUint32 aInterval, const char * *aFeatures, PRUint32 aFeatureCount) = 0;
...
#define NS_DECL_NSIPROFILER \
  NS_SCRIPTABLE NS_IMETHOD StartProfiler(PRUint32 aEntries, PRUint32 aInterval, const char * *aFeatures, PRUint32 aFeatureCount); \
...
#define NS_FORWARD_NSIPROFILER(_to) \
  NS_SCRIPTABLE NS_IMETHOD StartProfiler(PRUint32 aEntries, PRUint32 aInterval, const char * *aFeatures, PRUint32 aFeatureCount) { return _to StartProfiler(aEntries, aInterval, aFeatures, aFeatureCount); } \
...
#define NS_FORWARD_SAFE_NSIPROFILER(_to) \
  NS_SCRIPTABLE NS_IMETHOD StartProfiler(PRUint32 aEntries, PRUint32 aInterval, const char * *aFeatures, PRUint32 aFeatureCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartProfiler(aEntries, aInterval, aFeatures, aFeatureCount); } \
...
/* void StartProfiler (in PRUint32 aEntries, in PRUint32 aInterval, [array, size_is (aFeatureCount)] in string aFeatures, in PRUint32 aFeatureCount); */
NS_IMETHODIMP nsProfiler::StartProfiler(PRUint32 aEntries, PRUint32 aInterval, const char * *aFeatures, PRUint32 aFeatureCount)
{
