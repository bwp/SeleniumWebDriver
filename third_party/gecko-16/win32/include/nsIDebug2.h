...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDebug2 : public nsIDebug {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsDebuggerAttached(bool *aIsDebuggerAttached) = 0;
...
#define NS_DECL_NSIDEBUG2 \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsDebuggerAttached(bool *aIsDebuggerAttached); 
...
#define NS_FORWARD_NSIDEBUG2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsDebuggerAttached(bool *aIsDebuggerAttached) { return _to GetIsDebuggerAttached(aIsDebuggerAttached); } 
...
#define NS_FORWARD_SAFE_NSIDEBUG2(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetIsDebuggerAttached(bool *aIsDebuggerAttached) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsDebuggerAttached(aIsDebuggerAttached); } 
