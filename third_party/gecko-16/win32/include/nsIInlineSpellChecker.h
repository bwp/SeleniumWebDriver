...
class NS_NO_VTABLE NS_SCRIPTABLE nsIInlineSpellChecker : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIEditor *aEditor) = 0;

  /* void cleanup (in boolean aDestroyingFrames); */
  NS_SCRIPTABLE NS_IMETHOD Cleanup(bool aDestroyingFrames) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveWordFromDictionary(const nsAString & aWord) = 0;
...
#define NS_DECL_NSIINLINESPELLCHECKER \
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIEditor *aEditor); \
  NS_SCRIPTABLE NS_IMETHOD Cleanup(bool aDestroyingFrames); \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveWordFromDictionary(const nsAString & aWord); \
...
#define NS_FORWARD_NSIINLINESPELLCHECKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIEditor *aEditor) { return _to Init(aEditor); } \
  NS_SCRIPTABLE NS_IMETHOD Cleanup(bool aDestroyingFrames) { return _to Cleanup(aDestroyingFrames); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveWordFromDictionary(const nsAString & aWord) { return _to RemoveWordFromDictionary(aWord); } \
...
#define NS_FORWARD_SAFE_NSIINLINESPELLCHECKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIEditor *aEditor) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aEditor); } \
  NS_SCRIPTABLE NS_IMETHOD Cleanup(bool aDestroyingFrames) { return !_to ? NS_ERROR_NULL_POINTER : _to->Cleanup(aDestroyingFrames); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD RemoveWordFromDictionary(const nsAString & aWord) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveWordFromDictionary(aWord); } \
