...
class NS_NO_VTABLE NS_SCRIPTABLE nsIEditorIMESupport : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetPreferredIMEState(mozilla::widget::IMEState *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIEDITORIMESUPPORT \
  ...
  NS_IMETHOD GetPreferredIMEState(mozilla::widget::IMEState *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIEDITORIMESUPPORT(_to) \
  ...
  NS_IMETHOD GetPreferredIMEState(mozilla::widget::IMEState *_retval NS_OUTPARAM) { return _to GetPreferredIMEState(_retval); } \
...
#define NS_FORWARD_SAFE_NSIEDITORIMESUPPORT(_to) \
  ...
  NS_IMETHOD GetPreferredIMEState(mozilla::widget::IMEState *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPreferredIMEState(_retval); } \
...
/* [noscript] IMEState getPreferredIMEState (); */
NS_IMETHODIMP nsEditorIMESupport::GetPreferredIMEState(mozilla::widget::IMEState *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
