/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/nsIGfxInfoDebug.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIGfxInfoDebug : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SpoofVendorID(const nsAString & aVendorID) = 0;

  /* void spoofDeviceID (in DOMString aDeviceID); */
  NS_SCRIPTABLE NS_IMETHOD SpoofDeviceID(const nsAString & aDeviceID) = 0;
...
#define NS_DECL_NSIGFXINFODEBUG \
  NS_SCRIPTABLE NS_IMETHOD SpoofVendorID(const nsAString & aVendorID); \
  NS_SCRIPTABLE NS_IMETHOD SpoofDeviceID(const nsAString & aDeviceID); \
...
#define NS_FORWARD_NSIGFXINFODEBUG(_to) \
  NS_SCRIPTABLE NS_IMETHOD SpoofVendorID(const nsAString & aVendorID) { return _to SpoofVendorID(aVendorID); } \
  NS_SCRIPTABLE NS_IMETHOD SpoofDeviceID(const nsAString & aDeviceID) { return _to SpoofDeviceID(aDeviceID); } \
...
#define NS_FORWARD_SAFE_NSIGFXINFODEBUG(_to) \
  NS_SCRIPTABLE NS_IMETHOD SpoofVendorID(const nsAString & aVendorID) { return !_to ? NS_ERROR_NULL_POINTER : _to->SpoofVendorID(aVendorID); } \
  NS_SCRIPTABLE NS_IMETHOD SpoofDeviceID(const nsAString & aDeviceID) { return !_to ? NS_ERROR_NULL_POINTER : _to->SpoofDeviceID(aDeviceID); } \
