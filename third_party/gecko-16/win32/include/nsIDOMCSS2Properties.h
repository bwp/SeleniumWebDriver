...
#define NS_IDOMCSS2PROPERTIES_IID_STR "492673d6-039b-4d94-a598-dbf82abc174f"

#define NS_IDOMCSS2PROPERTIES_IID \
  {0x492673d6, 0x039b, 0x4d94, \
    { 0xa5, 0x98, 0xdb, 0xf8, 0x2a, 0xbc, 0x17, 0x4f }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMCSS2Properties : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTransform(nsAString & aTransform) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTransform(const nsAString & aTransform) = 0;

  /* attribute DOMString transformOrigin; */
  NS_SCRIPTABLE NS_IMETHOD GetTransformOrigin(nsAString & aTransformOrigin) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTransformOrigin(const nsAString & aTransformOrigin) = 0;

  /* attribute DOMString perspective; */
  NS_SCRIPTABLE NS_IMETHOD GetPerspective(nsAString & aPerspective) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetPerspective(const nsAString & aPerspective) = 0;

  /* attribute DOMString perspectiveOrigin; */
  NS_SCRIPTABLE NS_IMETHOD GetPerspectiveOrigin(nsAString & aPerspectiveOrigin) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetPerspectiveOrigin(const nsAString & aPerspectiveOrigin) = 0;

  /* attribute DOMString backfaceVisibility; */
  NS_SCRIPTABLE NS_IMETHOD GetBackfaceVisibility(nsAString & aBackfaceVisibility) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetBackfaceVisibility(const nsAString & aBackfaceVisibility) = 0;

  /* attribute DOMString transformStyle; */
  NS_SCRIPTABLE NS_IMETHOD GetTransformStyle(nsAString & aTransformStyle) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTransformStyle(const nsAString & aTransformStyle) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTransitionProperty(nsAString & aTransitionProperty) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTransitionProperty(const nsAString & aTransitionProperty) = 0;

  /* attribute DOMString transitionDuration; */
  NS_SCRIPTABLE NS_IMETHOD GetTransitionDuration(nsAString & aTransitionDuration) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTransitionDuration(const nsAString & aTransitionDuration) = 0;

  /* attribute DOMString transitionDelay; */
  NS_SCRIPTABLE NS_IMETHOD GetTransitionDelay(nsAString & aTransitionDelay) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTransitionDelay(const nsAString & aTransitionDelay) = 0;

  /* attribute DOMString transitionTimingFunction; */
  NS_SCRIPTABLE NS_IMETHOD GetTransitionTimingFunction(nsAString & aTransitionTimingFunction) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTransitionTimingFunction(const nsAString & aTransitionTimingFunction) = 0;

  /* attribute DOMString transition; */
  NS_SCRIPTABLE NS_IMETHOD GetTransition(nsAString & aTransition) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetTransition(const nsAString & aTransition) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAnimationName(const nsAString & aAnimationName) = 0;

  /* attribute DOMString animationDuration; */
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDuration(nsAString & aAnimationDuration) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDuration(const nsAString & aAnimationDuration) = 0;

  /* attribute DOMString animationDelay; */
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDelay(nsAString & aAnimationDelay) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDelay(const nsAString & aAnimationDelay) = 0;

  /* attribute DOMString animationTimingFunction; */
  NS_SCRIPTABLE NS_IMETHOD GetAnimationTimingFunction(nsAString & aAnimationTimingFunction) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAnimationTimingFunction(const nsAString & aAnimationTimingFunction) = 0;

  /* attribute DOMString animationDirection; */
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDirection(nsAString & aAnimationDirection) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDirection(const nsAString & aAnimationDirection) = 0;

  /* attribute DOMString animationFillMode; */
  NS_SCRIPTABLE NS_IMETHOD GetAnimationFillMode(nsAString & aAnimationFillMode) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAnimationFillMode(const nsAString & aAnimationFillMode) = 0;

  /* attribute DOMString animationIterationCount; */
  NS_SCRIPTABLE NS_IMETHOD GetAnimationIterationCount(nsAString & aAnimationIterationCount) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAnimationIterationCount(const nsAString & aAnimationIterationCount) = 0;

  /* attribute DOMString animationPlayState; */
  NS_SCRIPTABLE NS_IMETHOD GetAnimationPlayState(nsAString & aAnimationPlayState) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAnimationPlayState(const nsAString & aAnimationPlayState) = 0;

  /* attribute DOMString animation; */
  NS_SCRIPTABLE NS_IMETHOD GetAnimation(nsAString & aAnimation) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetAnimation(const nsAString & aAnimation) = 0;
...
#define NS_DECL_NSIDOMCSS2PROPERTIES \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTransform(nsAString & aTransform); \
  NS_SCRIPTABLE NS_IMETHOD SetTransform(const nsAString & aTransform); \
  NS_SCRIPTABLE NS_IMETHOD GetTransformOrigin(nsAString & aTransformOrigin); \
  NS_SCRIPTABLE NS_IMETHOD SetTransformOrigin(const nsAString & aTransformOrigin); \
  NS_SCRIPTABLE NS_IMETHOD GetPerspective(nsAString & aPerspective); \
  NS_SCRIPTABLE NS_IMETHOD SetPerspective(const nsAString & aPerspective); \
  NS_SCRIPTABLE NS_IMETHOD GetPerspectiveOrigin(nsAString & aPerspectiveOrigin); \
  NS_SCRIPTABLE NS_IMETHOD SetPerspectiveOrigin(const nsAString & aPerspectiveOrigin); \
  NS_SCRIPTABLE NS_IMETHOD GetBackfaceVisibility(nsAString & aBackfaceVisibility); \
  NS_SCRIPTABLE NS_IMETHOD SetBackfaceVisibility(const nsAString & aBackfaceVisibility); \
  NS_SCRIPTABLE NS_IMETHOD GetTransformStyle(nsAString & aTransformStyle); \
  NS_SCRIPTABLE NS_IMETHOD SetTransformStyle(const nsAString & aTransformStyle); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTransitionProperty(nsAString & aTransitionProperty); \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionProperty(const nsAString & aTransitionProperty); \
  NS_SCRIPTABLE NS_IMETHOD GetTransitionDuration(nsAString & aTransitionDuration); \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionDuration(const nsAString & aTransitionDuration); \
  NS_SCRIPTABLE NS_IMETHOD GetTransitionDelay(nsAString & aTransitionDelay); \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionDelay(const nsAString & aTransitionDelay); \
  NS_SCRIPTABLE NS_IMETHOD GetTransitionTimingFunction(nsAString & aTransitionTimingFunction); \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionTimingFunction(const nsAString & aTransitionTimingFunction); \
  NS_SCRIPTABLE NS_IMETHOD GetTransition(nsAString & aTransition); \
  NS_SCRIPTABLE NS_IMETHOD SetTransition(const nsAString & aTransition); \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAnimationName(const nsAString & aAnimationName); \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDuration(nsAString & aAnimationDuration); \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDuration(const nsAString & aAnimationDuration); \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDelay(nsAString & aAnimationDelay); \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDelay(const nsAString & aAnimationDelay); \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationTimingFunction(nsAString & aAnimationTimingFunction); \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationTimingFunction(const nsAString & aAnimationTimingFunction); \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDirection(nsAString & aAnimationDirection); \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDirection(const nsAString & aAnimationDirection); \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationFillMode(nsAString & aAnimationFillMode); \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationFillMode(const nsAString & aAnimationFillMode); \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationIterationCount(nsAString & aAnimationIterationCount); \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationIterationCount(const nsAString & aAnimationIterationCount); \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationPlayState(nsAString & aAnimationPlayState); \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationPlayState(const nsAString & aAnimationPlayState); \
  NS_SCRIPTABLE NS_IMETHOD GetAnimation(nsAString & aAnimation); \
  NS_SCRIPTABLE NS_IMETHOD SetAnimation(const nsAString & aAnimation); \
...
#define NS_FORWARD_NSIDOMCSS2PROPERTIES(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTransform(nsAString & aTransform) { return _to GetTransform(aTransform); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransform(const nsAString & aTransform) { return _to SetTransform(aTransform); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransformOrigin(nsAString & aTransformOrigin) { return _to GetTransformOrigin(aTransformOrigin); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransformOrigin(const nsAString & aTransformOrigin) { return _to SetTransformOrigin(aTransformOrigin); } \
  NS_SCRIPTABLE NS_IMETHOD GetPerspective(nsAString & aPerspective) { return _to GetPerspective(aPerspective); } \
  NS_SCRIPTABLE NS_IMETHOD SetPerspective(const nsAString & aPerspective) { return _to SetPerspective(aPerspective); } \
  NS_SCRIPTABLE NS_IMETHOD GetPerspectiveOrigin(nsAString & aPerspectiveOrigin) { return _to GetPerspectiveOrigin(aPerspectiveOrigin); } \
  NS_SCRIPTABLE NS_IMETHOD SetPerspectiveOrigin(const nsAString & aPerspectiveOrigin) { return _to SetPerspectiveOrigin(aPerspectiveOrigin); } \
  NS_SCRIPTABLE NS_IMETHOD GetBackfaceVisibility(nsAString & aBackfaceVisibility) { return _to GetBackfaceVisibility(aBackfaceVisibility); } \
  NS_SCRIPTABLE NS_IMETHOD SetBackfaceVisibility(const nsAString & aBackfaceVisibility) { return _to SetBackfaceVisibility(aBackfaceVisibility); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransformStyle(nsAString & aTransformStyle) { return _to GetTransformStyle(aTransformStyle); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransformStyle(const nsAString & aTransformStyle) { return _to SetTransformStyle(aTransformStyle); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTransitionProperty(nsAString & aTransitionProperty) { return _to GetTransitionProperty(aTransitionProperty); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionProperty(const nsAString & aTransitionProperty) { return _to SetTransitionProperty(aTransitionProperty); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransitionDuration(nsAString & aTransitionDuration) { return _to GetTransitionDuration(aTransitionDuration); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionDuration(const nsAString & aTransitionDuration) { return _to SetTransitionDuration(aTransitionDuration); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransitionDelay(nsAString & aTransitionDelay) { return _to GetTransitionDelay(aTransitionDelay); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionDelay(const nsAString & aTransitionDelay) { return _to SetTransitionDelay(aTransitionDelay); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransitionTimingFunction(nsAString & aTransitionTimingFunction) { return _to GetTransitionTimingFunction(aTransitionTimingFunction); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionTimingFunction(const nsAString & aTransitionTimingFunction) { return _to SetTransitionTimingFunction(aTransitionTimingFunction); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransition(nsAString & aTransition) { return _to GetTransition(aTransition); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransition(const nsAString & aTransition) { return _to SetTransition(aTransition); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAnimationName(const nsAString & aAnimationName) { return _to SetAnimationName(aAnimationName); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDuration(nsAString & aAnimationDuration) { return _to GetAnimationDuration(aAnimationDuration); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDuration(const nsAString & aAnimationDuration) { return _to SetAnimationDuration(aAnimationDuration); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDelay(nsAString & aAnimationDelay) { return _to GetAnimationDelay(aAnimationDelay); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDelay(const nsAString & aAnimationDelay) { return _to SetAnimationDelay(aAnimationDelay); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationTimingFunction(nsAString & aAnimationTimingFunction) { return _to GetAnimationTimingFunction(aAnimationTimingFunction); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationTimingFunction(const nsAString & aAnimationTimingFunction) { return _to SetAnimationTimingFunction(aAnimationTimingFunction); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDirection(nsAString & aAnimationDirection) { return _to GetAnimationDirection(aAnimationDirection); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDirection(const nsAString & aAnimationDirection) { return _to SetAnimationDirection(aAnimationDirection); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationFillMode(nsAString & aAnimationFillMode) { return _to GetAnimationFillMode(aAnimationFillMode); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationFillMode(const nsAString & aAnimationFillMode) { return _to SetAnimationFillMode(aAnimationFillMode); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationIterationCount(nsAString & aAnimationIterationCount) { return _to GetAnimationIterationCount(aAnimationIterationCount); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationIterationCount(const nsAString & aAnimationIterationCount) { return _to SetAnimationIterationCount(aAnimationIterationCount); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationPlayState(nsAString & aAnimationPlayState) { return _to GetAnimationPlayState(aAnimationPlayState); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationPlayState(const nsAString & aAnimationPlayState) { return _to SetAnimationPlayState(aAnimationPlayState); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimation(nsAString & aAnimation) { return _to GetAnimation(aAnimation); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimation(const nsAString & aAnimation) { return _to SetAnimation(aAnimation); } \
...
#define NS_FORWARD_SAFE_NSIDOMCSS2PROPERTIES(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTransform(nsAString & aTransform) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransform(aTransform); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransform(const nsAString & aTransform) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTransform(aTransform); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransformOrigin(nsAString & aTransformOrigin) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransformOrigin(aTransformOrigin); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransformOrigin(const nsAString & aTransformOrigin) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTransformOrigin(aTransformOrigin); } \
  NS_SCRIPTABLE NS_IMETHOD GetPerspective(nsAString & aPerspective) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPerspective(aPerspective); } \
  NS_SCRIPTABLE NS_IMETHOD SetPerspective(const nsAString & aPerspective) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPerspective(aPerspective); } \
  NS_SCRIPTABLE NS_IMETHOD GetPerspectiveOrigin(nsAString & aPerspectiveOrigin) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPerspectiveOrigin(aPerspectiveOrigin); } \
  NS_SCRIPTABLE NS_IMETHOD SetPerspectiveOrigin(const nsAString & aPerspectiveOrigin) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetPerspectiveOrigin(aPerspectiveOrigin); } \
  NS_SCRIPTABLE NS_IMETHOD GetBackfaceVisibility(nsAString & aBackfaceVisibility) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBackfaceVisibility(aBackfaceVisibility); } \
  NS_SCRIPTABLE NS_IMETHOD SetBackfaceVisibility(const nsAString & aBackfaceVisibility) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetBackfaceVisibility(aBackfaceVisibility); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransformStyle(nsAString & aTransformStyle) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransformStyle(aTransformStyle); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransformStyle(const nsAString & aTransformStyle) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTransformStyle(aTransformStyle); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetTransitionProperty(nsAString & aTransitionProperty) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransitionProperty(aTransitionProperty); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionProperty(const nsAString & aTransitionProperty) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTransitionProperty(aTransitionProperty); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransitionDuration(nsAString & aTransitionDuration) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransitionDuration(aTransitionDuration); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionDuration(const nsAString & aTransitionDuration) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTransitionDuration(aTransitionDuration); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransitionDelay(nsAString & aTransitionDelay) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransitionDelay(aTransitionDelay); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionDelay(const nsAString & aTransitionDelay) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTransitionDelay(aTransitionDelay); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransitionTimingFunction(nsAString & aTransitionTimingFunction) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransitionTimingFunction(aTransitionTimingFunction); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransitionTimingFunction(const nsAString & aTransitionTimingFunction) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTransitionTimingFunction(aTransitionTimingFunction); } \
  NS_SCRIPTABLE NS_IMETHOD GetTransition(nsAString & aTransition) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTransition(aTransition); } \
  NS_SCRIPTABLE NS_IMETHOD SetTransition(const nsAString & aTransition) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetTransition(aTransition); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAnimationName(const nsAString & aAnimationName) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAnimationName(aAnimationName); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDuration(nsAString & aAnimationDuration) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimationDuration(aAnimationDuration); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDuration(const nsAString & aAnimationDuration) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAnimationDuration(aAnimationDuration); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDelay(nsAString & aAnimationDelay) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimationDelay(aAnimationDelay); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDelay(const nsAString & aAnimationDelay) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAnimationDelay(aAnimationDelay); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationTimingFunction(nsAString & aAnimationTimingFunction) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimationTimingFunction(aAnimationTimingFunction); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationTimingFunction(const nsAString & aAnimationTimingFunction) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAnimationTimingFunction(aAnimationTimingFunction); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationDirection(nsAString & aAnimationDirection) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimationDirection(aAnimationDirection); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationDirection(const nsAString & aAnimationDirection) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAnimationDirection(aAnimationDirection); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationFillMode(nsAString & aAnimationFillMode) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimationFillMode(aAnimationFillMode); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationFillMode(const nsAString & aAnimationFillMode) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAnimationFillMode(aAnimationFillMode); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationIterationCount(nsAString & aAnimationIterationCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimationIterationCount(aAnimationIterationCount); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationIterationCount(const nsAString & aAnimationIterationCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAnimationIterationCount(aAnimationIterationCount); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimationPlayState(nsAString & aAnimationPlayState) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimationPlayState(aAnimationPlayState); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimationPlayState(const nsAString & aAnimationPlayState) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAnimationPlayState(aAnimationPlayState); } \
  NS_SCRIPTABLE NS_IMETHOD GetAnimation(nsAString & aAnimation) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAnimation(aAnimation); } \
  NS_SCRIPTABLE NS_IMETHOD SetAnimation(const nsAString & aAnimation) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAnimation(aAnimation); } \
