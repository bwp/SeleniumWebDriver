...
class NS_NO_VTABLE NS_SCRIPTABLE nsICrashReporter : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMinidumpPath(nsIFile * *aMinidumpPath) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetMinidumpPath(nsIFile *aMinidumpPath) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSubmitReports(bool *aSubmitReports) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetSubmitReports(bool aSubmitReports) = 0;
...
#define NS_DECL_NSICRASHREPORTER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMinidumpPath(nsIFile * *aMinidumpPath); \
  NS_SCRIPTABLE NS_IMETHOD SetMinidumpPath(nsIFile *aMinidumpPath); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSubmitReports(bool *aSubmitReports); \
  NS_SCRIPTABLE NS_IMETHOD SetSubmitReports(bool aSubmitReports); 
...
#define NS_FORWARD_NSICRASHREPORTER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMinidumpPath(nsIFile * *aMinidumpPath) { return _to GetMinidumpPath(aMinidumpPath); } \
  NS_SCRIPTABLE NS_IMETHOD SetMinidumpPath(nsIFile *aMinidumpPath) { return _to SetMinidumpPath(aMinidumpPath); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSubmitReports(bool *aSubmitReports) { return _to GetSubmitReports(aSubmitReports); } \
  NS_SCRIPTABLE NS_IMETHOD SetSubmitReports(bool aSubmitReports) { return _to SetSubmitReports(aSubmitReports); } 
...
#define NS_FORWARD_SAFE_NSICRASHREPORTER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMinidumpPath(nsIFile * *aMinidumpPath) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMinidumpPath(aMinidumpPath); } \
  NS_SCRIPTABLE NS_IMETHOD SetMinidumpPath(nsIFile *aMinidumpPath) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMinidumpPath(aMinidumpPath); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSubmitReports(bool *aSubmitReports) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSubmitReports(aSubmitReports); } \
  NS_SCRIPTABLE NS_IMETHOD SetSubmitReports(bool aSubmitReports) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetSubmitReports(aSubmitReports); } 
