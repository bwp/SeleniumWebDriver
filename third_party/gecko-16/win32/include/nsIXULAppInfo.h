...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXULAppInfo : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUAName(nsACString & aUAName) = 0;
...
#define NS_DECL_NSIXULAPPINFO \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUAName(nsACString & aUAName); 
...
#define NS_FORWARD_NSIXULAPPINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUAName(nsACString & aUAName) { return _to GetUAName(aUAName); } 
...
#define NS_FORWARD_SAFE_NSIXULAPPINFO(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUAName(nsACString & aUAName) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUAName(aUAName); } 
