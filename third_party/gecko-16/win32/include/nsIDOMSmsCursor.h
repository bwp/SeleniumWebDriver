/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/sms/interfaces/nsIDOMSmsCursor.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMozSmsCursor : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMMOZSMSCURSOR_IID)

  /* readonly attribute nsIDOMMozSmsMessage message; */
  NS_SCRIPTABLE NS_IMETHOD GetMessage(nsIDOMMozSmsMessage * *aMessage) = 0;

  /* void continue (); */
  NS_SCRIPTABLE NS_IMETHOD Continue(void) = 0;
...
#define NS_DECL_NSIDOMMOZSMSCURSOR \
  NS_SCRIPTABLE NS_IMETHOD GetMessage(nsIDOMMozSmsMessage * *aMessage); \
  NS_SCRIPTABLE NS_IMETHOD Continue(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMMOZSMSCURSOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetMessage(nsIDOMMozSmsMessage * *aMessage) { return _to GetMessage(aMessage); } \
  NS_SCRIPTABLE NS_IMETHOD Continue(void) { return _to Continue(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMMOZSMSCURSOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetMessage(nsIDOMMozSmsMessage * *aMessage) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMessage(aMessage); } \
  NS_SCRIPTABLE NS_IMETHOD Continue(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Continue(); } 
