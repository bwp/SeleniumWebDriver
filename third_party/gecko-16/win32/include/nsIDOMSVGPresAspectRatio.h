...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGPreserveAspectRatio : public nsISupports {
 public: 
  ...
  enum {
    SVG_PRESERVEASPECTRATIO_UNKNOWN = 0U,
    SVG_PRESERVEASPECTRATIO_NONE = 1U,
    SVG_PRESERVEASPECTRATIO_XMINYMIN = 2U,
    SVG_PRESERVEASPECTRATIO_XMIDYMIN = 3U,
    SVG_PRESERVEASPECTRATIO_XMAXYMIN = 4U,
    SVG_PRESERVEASPECTRATIO_XMINYMID = 5U,
    SVG_PRESERVEASPECTRATIO_XMIDYMID = 6U,
    SVG_PRESERVEASPECTRATIO_XMAXYMID = 7U,
    SVG_PRESERVEASPECTRATIO_XMINYMAX = 8U,
    SVG_PRESERVEASPECTRATIO_XMIDYMAX = 9U,
    SVG_PRESERVEASPECTRATIO_XMAXYMAX = 10U,
    SVG_MEETORSLICE_UNKNOWN = 0U,
    SVG_MEETORSLICE_MEET = 1U,
    SVG_MEETORSLICE_SLICE = 2U
  };
