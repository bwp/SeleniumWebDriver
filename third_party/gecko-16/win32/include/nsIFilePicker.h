/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/nsIFilePicker.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFilePicker : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplayDirectory(nsIFile * *aDisplayDirectory) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetDisplayDirectory(nsIFile *aDisplayDirectory) = 0;
...
#define NS_DECL_NSIFILEPICKER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplayDirectory(nsIFile * *aDisplayDirectory); \
  NS_SCRIPTABLE NS_IMETHOD SetDisplayDirectory(nsIFile *aDisplayDirectory); \
...
#define NS_FORWARD_NSIFILEPICKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplayDirectory(nsIFile * *aDisplayDirectory) { return _to GetDisplayDirectory(aDisplayDirectory); } \
  NS_SCRIPTABLE NS_IMETHOD SetDisplayDirectory(nsIFile *aDisplayDirectory) { return _to SetDisplayDirectory(aDisplayDirectory); } \
...
#define NS_FORWARD_SAFE_NSIFILEPICKER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDisplayDirectory(nsIFile * *aDisplayDirectory) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDisplayDirectory(aDisplayDirectory); } \
  NS_SCRIPTABLE NS_IMETHOD SetDisplayDirectory(nsIFile *aDisplayDirectory) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDisplayDirectory(aDisplayDirectory); } \
