...
class NS_NO_VTABLE NS_SCRIPTABLE nsPIExternalAppLauncher : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD DeleteTemporaryPrivateFileWhenPossible(nsIFile *aTemporaryFile) = 0;
...
#define NS_DECL_NSPIEXTERNALAPPLAUNCHER \
  ...
  NS_SCRIPTABLE NS_IMETHOD DeleteTemporaryPrivateFileWhenPossible(nsIFile *aTemporaryFile); 
...
#define NS_FORWARD_NSPIEXTERNALAPPLAUNCHER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD DeleteTemporaryPrivateFileWhenPossible(nsIFile *aTemporaryFile) { return _to DeleteTemporaryPrivateFileWhenPossible(aTemporaryFile); } 
...
#define NS_FORWARD_SAFE_NSPIEXTERNALAPPLAUNCHER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD DeleteTemporaryPrivateFileWhenPossible(nsIFile *aTemporaryFile) { return !_to ? NS_ERROR_NULL_POINTER : _to->DeleteTemporaryPrivateFileWhenPossible(aTemporaryFile); } 
