...
typedef PRInt16  PivotMoveReason;
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessiblePivot : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD MoveToPoint(nsIAccessibleTraversalRule *aRule, PRInt32 aX, PRInt32 aY, bool aIgnoreNoMatch, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIACCESSIBLEPIVOT \
  ...
  NS_SCRIPTABLE NS_IMETHOD MoveToPoint(nsIAccessibleTraversalRule *aRule, PRInt32 aX, PRInt32 aY, bool aIgnoreNoMatch, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIACCESSIBLEPIVOT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MoveToPoint(nsIAccessibleTraversalRule *aRule, PRInt32 aX, PRInt32 aY, bool aIgnoreNoMatch, bool *_retval NS_OUTPARAM) { return _to MoveToPoint(aRule, aX, aY, aIgnoreNoMatch, _retval); } \
...
#define NS_FORWARD_SAFE_NSIACCESSIBLEPIVOT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MoveToPoint(nsIAccessibleTraversalRule *aRule, PRInt32 aX, PRInt32 aY, bool aIgnoreNoMatch, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->MoveToPoint(aRule, aX, aY, aIgnoreNoMatch, _retval); } \
...
/* boolean moveToPoint (in nsIAccessibleTraversalRule aRule, in long aX, in long aY, in boolean aIgnoreNoMatch); */
NS_IMETHODIMP nsAccessiblePivot::MoveToPoint(nsIAccessibleTraversalRule *aRule, PRInt32 aX, PRInt32 aY, bool aIgnoreNoMatch, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessiblePivotObserver : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnPivotChanged(nsIAccessiblePivot *aPivot, nsIAccessible *aOldAccessible, PRInt32 aOldStart, PRInt32 aOldEnd, PivotMoveReason aReason) = 0;
...
#define NS_DECL_NSIACCESSIBLEPIVOTOBSERVER \
  NS_SCRIPTABLE NS_IMETHOD OnPivotChanged(nsIAccessiblePivot *aPivot, nsIAccessible *aOldAccessible, PRInt32 aOldStart, PRInt32 aOldEnd, PivotMoveReason aReason); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIACCESSIBLEPIVOTOBSERVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnPivotChanged(nsIAccessiblePivot *aPivot, nsIAccessible *aOldAccessible, PRInt32 aOldStart, PRInt32 aOldEnd, PivotMoveReason aReason) { return _to OnPivotChanged(aPivot, aOldAccessible, aOldStart, aOldEnd, aReason); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIACCESSIBLEPIVOTOBSERVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD OnPivotChanged(nsIAccessiblePivot *aPivot, nsIAccessible *aOldAccessible, PRInt32 aOldStart, PRInt32 aOldEnd, PivotMoveReason aReason) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnPivotChanged(aPivot, aOldAccessible, aOldStart, aOldEnd, aReason); } 
...
/* void onPivotChanged (in nsIAccessiblePivot aPivot, in nsIAccessible aOldAccessible, in long aOldStart, in long aOldEnd, in PivotMoveReason aReason); */
NS_IMETHODIMP nsAccessiblePivotObserver::OnPivotChanged(nsIAccessiblePivot *aPivot, nsIAccessible *aOldAccessible, PRInt32 aOldStart, PRInt32 aOldEnd, PivotMoveReason aReason)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
