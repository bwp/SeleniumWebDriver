...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleHideEvent : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IACCESSIBLEHIDEEVENT_IID)

  /* readonly attribute nsIAccessible targetParent; */
  NS_SCRIPTABLE NS_IMETHOD GetTargetParent(nsIAccessible * *aTargetParent) = 0;

  /* readonly attribute nsIAccessible targetNextSibling; */
  NS_SCRIPTABLE NS_IMETHOD GetTargetNextSibling(nsIAccessible * *aTargetNextSibling) = 0;

  /* readonly attribute nsIAccessible targetPrevSibling; */
  NS_SCRIPTABLE NS_IMETHOD GetTargetPrevSibling(nsIAccessible * *aTargetPrevSibling) = 0;
...
#define NS_DECL_NSIACCESSIBLEHIDEEVENT \
  NS_SCRIPTABLE NS_IMETHOD GetTargetParent(nsIAccessible * *aTargetParent); \
  NS_SCRIPTABLE NS_IMETHOD GetTargetNextSibling(nsIAccessible * *aTargetNextSibling); \
  NS_SCRIPTABLE NS_IMETHOD GetTargetPrevSibling(nsIAccessible * *aTargetPrevSibling); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIACCESSIBLEHIDEEVENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetTargetParent(nsIAccessible * *aTargetParent) { return _to GetTargetParent(aTargetParent); } \
  NS_SCRIPTABLE NS_IMETHOD GetTargetNextSibling(nsIAccessible * *aTargetNextSibling) { return _to GetTargetNextSibling(aTargetNextSibling); } \
  NS_SCRIPTABLE NS_IMETHOD GetTargetPrevSibling(nsIAccessible * *aTargetPrevSibling) { return _to GetTargetPrevSibling(aTargetPrevSibling); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIACCESSIBLEHIDEEVENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetTargetParent(nsIAccessible * *aTargetParent) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTargetParent(aTargetParent); } \
  NS_SCRIPTABLE NS_IMETHOD GetTargetNextSibling(nsIAccessible * *aTargetNextSibling) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTargetNextSibling(aTargetNextSibling); } \
  NS_SCRIPTABLE NS_IMETHOD GetTargetPrevSibling(nsIAccessible * *aTargetPrevSibling) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTargetPrevSibling(aTargetPrevSibling); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessibleVirtualCursorChangeEvent : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IACCESSIBLEVIRTUALCURSORCHANGEEVENT_IID)

  /* readonly attribute nsIAccessible oldAccessible; */
  NS_SCRIPTABLE NS_IMETHOD GetOldAccessible(nsIAccessible * *aOldAccessible) = 0;

  /* readonly attribute long oldStartOffset; */
  NS_SCRIPTABLE NS_IMETHOD GetOldStartOffset(PRInt32 *aOldStartOffset) = 0;

  /* readonly attribute long oldEndOffset; */
  NS_SCRIPTABLE NS_IMETHOD GetOldEndOffset(PRInt32 *aOldEndOffset) = 0;

  /* readonly attribute short reason; */
  NS_SCRIPTABLE NS_IMETHOD GetReason(PRInt16 *aReason) = 0;
...
#define NS_DECL_NSIACCESSIBLEVIRTUALCURSORCHANGEEVENT \
  NS_SCRIPTABLE NS_IMETHOD GetOldAccessible(nsIAccessible * *aOldAccessible); \
  NS_SCRIPTABLE NS_IMETHOD GetOldStartOffset(PRInt32 *aOldStartOffset); \
  NS_SCRIPTABLE NS_IMETHOD GetOldEndOffset(PRInt32 *aOldEndOffset); \
  NS_SCRIPTABLE NS_IMETHOD GetReason(PRInt16 *aReason); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIACCESSIBLEVIRTUALCURSORCHANGEEVENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetOldAccessible(nsIAccessible * *aOldAccessible) { return _to GetOldAccessible(aOldAccessible); } \
  NS_SCRIPTABLE NS_IMETHOD GetOldStartOffset(PRInt32 *aOldStartOffset) { return _to GetOldStartOffset(aOldStartOffset); } \
  NS_SCRIPTABLE NS_IMETHOD GetOldEndOffset(PRInt32 *aOldEndOffset) { return _to GetOldEndOffset(aOldEndOffset); } \
  NS_SCRIPTABLE NS_IMETHOD GetReason(PRInt16 *aReason) { return _to GetReason(aReason); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIACCESSIBLEVIRTUALCURSORCHANGEEVENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetOldAccessible(nsIAccessible * *aOldAccessible) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOldAccessible(aOldAccessible); } \
  NS_SCRIPTABLE NS_IMETHOD GetOldStartOffset(PRInt32 *aOldStartOffset) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOldStartOffset(aOldStartOffset); } \
  NS_SCRIPTABLE NS_IMETHOD GetOldEndOffset(PRInt32 *aOldEndOffset) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOldEndOffset(aOldEndOffset); } \
  NS_SCRIPTABLE NS_IMETHOD GetReason(PRInt16 *aReason) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetReason(aReason); } 
...
/* readonly attribute long oldStartOffset; */
NS_IMETHODIMP nsAccessibleVirtualCursorChangeEvent::GetOldStartOffset(PRInt32 *aOldStartOffset)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute long oldEndOffset; */
NS_IMETHODIMP nsAccessibleVirtualCursorChangeEvent::GetOldEndOffset(PRInt32 *aOldEndOffset)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute short reason; */
NS_IMETHODIMP nsAccessibleVirtualCursorChangeEvent::GetReason(PRInt16 *aReason)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
