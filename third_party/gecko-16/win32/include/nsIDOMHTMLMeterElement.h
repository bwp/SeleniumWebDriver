/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/html/nsIDOMHTMLMeterElement.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLMeterElement : public nsIDOMHTMLElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetMin(double aMin) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLow(double *aLow) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetLow(double aLow) = 0;

  /* attribute double high; */
  NS_SCRIPTABLE NS_IMETHOD GetHigh(double *aHigh) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetHigh(double aHigh) = 0;

  /* attribute double optimum; */
  NS_SCRIPTABLE NS_IMETHOD GetOptimum(double *aOptimum) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetOptimum(double aOptimum) = 0;
...
#define NS_DECL_NSIDOMHTMLMETERELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetMin(double aMin); \
  NS_SCRIPTABLE NS_IMETHOD GetMax(double *aMax); \
  NS_SCRIPTABLE NS_IMETHOD SetMax(double aMax); \
  NS_SCRIPTABLE NS_IMETHOD GetLow(double *aLow); \
  NS_SCRIPTABLE NS_IMETHOD SetLow(double aLow); \
  NS_SCRIPTABLE NS_IMETHOD GetHigh(double *aHigh); \
  NS_SCRIPTABLE NS_IMETHOD SetHigh(double aHigh); \
  NS_SCRIPTABLE NS_IMETHOD GetOptimum(double *aOptimum); \
  NS_SCRIPTABLE NS_IMETHOD SetOptimum(double aOptimum); 
...
#define NS_FORWARD_NSIDOMHTMLMETERELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetMin(double aMin) { return _to SetMin(aMin); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLow(double *aLow) { return _to GetLow(aLow); } \
  NS_SCRIPTABLE NS_IMETHOD SetLow(double aLow) { return _to SetLow(aLow); } \
  NS_SCRIPTABLE NS_IMETHOD GetHigh(double *aHigh) { return _to GetHigh(aHigh); } \
  NS_SCRIPTABLE NS_IMETHOD SetHigh(double aHigh) { return _to SetHigh(aHigh); } \
  NS_SCRIPTABLE NS_IMETHOD GetOptimum(double *aOptimum) { return _to GetOptimum(aOptimum); } \
  NS_SCRIPTABLE NS_IMETHOD SetOptimum(double aOptimum) { return _to SetOptimum(aOptimum); } 
...
#define NS_FORWARD_SAFE_NSIDOMHTMLMETERELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetMin(double aMin) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMin(aMin); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLow(double *aLow) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLow(aLow); } \
  NS_SCRIPTABLE NS_IMETHOD SetLow(double aLow) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetLow(aLow); } \
  NS_SCRIPTABLE NS_IMETHOD GetHigh(double *aHigh) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHigh(aHigh); } \
  NS_SCRIPTABLE NS_IMETHOD SetHigh(double aHigh) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetHigh(aHigh); } \
  NS_SCRIPTABLE NS_IMETHOD GetOptimum(double *aOptimum) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOptimum(aOptimum); } \
  NS_SCRIPTABLE NS_IMETHOD SetOptimum(double aOptimum) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOptimum(aOptimum); } 
