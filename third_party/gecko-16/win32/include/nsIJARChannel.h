...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJARChannel : public nsIChannel {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAppURI(nsIURI *uri) = 0;
...
#define NS_DECL_NSIJARCHANNEL \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAppURI(nsIURI *uri); 
...
#define NS_FORWARD_NSIJARCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAppURI(nsIURI *uri) { return _to SetAppURI(uri); } 
...
#define NS_FORWARD_SAFE_NSIJARCHANNEL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetAppURI(nsIURI *uri) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetAppURI(uri); } 
