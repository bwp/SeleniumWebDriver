/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/nsIWinTaskbar.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWinTaskbar : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetAvailable(bool *aAvailable) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOverlayIconController(nsIDocShell *shell, nsITaskbarOverlayIconController * *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD PrepareFullScreen(nsIDOMWindow *aWindow, bool aFullScreen) = 0;
...
#define NS_DECL_NSIWINTASKBAR \
  NS_SCRIPTABLE NS_IMETHOD GetAvailable(bool *aAvailable); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOverlayIconController(nsIDocShell *shell, nsITaskbarOverlayIconController * *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD PrepareFullScreen(nsIDOMWindow *aWindow, bool aFullScreen); \
  NS_IMETHOD PrepareFullScreenHWND(void *aWindow, bool aFullScreen); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWINTASKBAR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAvailable(bool *aAvailable) { return _to GetAvailable(aAvailable); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOverlayIconController(nsIDocShell *shell, nsITaskbarOverlayIconController * *_retval NS_OUTPARAM) { return _to GetOverlayIconController(shell, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD PrepareFullScreen(nsIDOMWindow *aWindow, bool aFullScreen) { return _to PrepareFullScreen(aWindow, aFullScreen); } \
...
#define NS_FORWARD_SAFE_NSIWINTASKBAR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetAvailable(bool *aAvailable) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetAvailable(aAvailable); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOverlayIconController(nsIDocShell *shell, nsITaskbarOverlayIconController * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOverlayIconController(shell, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD PrepareFullScreen(nsIDOMWindow *aWindow, bool aFullScreen) { return !_to ? NS_ERROR_NULL_POINTER : _to->PrepareFullScreen(aWindow, aFullScreen); } \
...
/* nsITaskbarOverlayIconController getOverlayIconController (in nsIDocShell shell); */
NS_IMETHODIMP nsWinTaskbar::GetOverlayIconController(nsIDocShell *shell, nsITaskbarOverlayIconController * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
