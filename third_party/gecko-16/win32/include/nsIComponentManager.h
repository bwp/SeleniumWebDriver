...
class NS_NO_VTABLE NS_SCRIPTABLE nsIComponentManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD AddBootstrappedManifestLocation(nsIFile *aLocation) = 0;

  /* void removeBootstrappedManifestLocation (in nsIFile aLocation); */
  NS_SCRIPTABLE NS_IMETHOD RemoveBootstrappedManifestLocation(nsIFile *aLocation) = 0;
...
#define NS_DECL_NSICOMPONENTMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddBootstrappedManifestLocation(nsIFile *aLocation); \
  NS_SCRIPTABLE NS_IMETHOD RemoveBootstrappedManifestLocation(nsIFile *aLocation); 
...
#define NS_FORWARD_NSICOMPONENTMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddBootstrappedManifestLocation(nsIFile *aLocation) { return _to AddBootstrappedManifestLocation(aLocation); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveBootstrappedManifestLocation(nsIFile *aLocation) { return _to RemoveBootstrappedManifestLocation(aLocation); } 
...
#define NS_FORWARD_SAFE_NSICOMPONENTMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD AddBootstrappedManifestLocation(nsIFile *aLocation) { return !_to ? NS_ERROR_NULL_POINTER : _to->AddBootstrappedManifestLocation(aLocation); } \
  NS_SCRIPTABLE NS_IMETHOD RemoveBootstrappedManifestLocation(nsIFile *aLocation) { return !_to ? NS_ERROR_NULL_POINTER : _to->RemoveBootstrappedManifestLocation(aLocation); } 
