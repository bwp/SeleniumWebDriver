/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/js/xpconnect/idl/xpcjsid.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJSCID : public nsIJSID {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateInstance(const JS::Value & iid, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM) = 0;

  /* [implicit_jscontext,optional_argc] jsval getService ([optional] in jsval iid); */
  NS_SCRIPTABLE NS_IMETHOD GetService(const JS::Value & iid, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIJSCID \
  NS_SCRIPTABLE NS_IMETHOD CreateInstance(const JS::Value & iid, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetService(const JS::Value & iid, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIJSCID(_to) \
  NS_SCRIPTABLE NS_IMETHOD CreateInstance(const JS::Value & iid, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM) { return _to CreateInstance(iid, cx, _argc, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetService(const JS::Value & iid, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM) { return _to GetService(iid, cx, _argc, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIJSCID(_to) \
  NS_SCRIPTABLE NS_IMETHOD CreateInstance(const JS::Value & iid, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateInstance(iid, cx, _argc, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetService(const JS::Value & iid, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetService(iid, cx, _argc, _retval); } 
...
/* [implicit_jscontext,optional_argc] jsval createInstance ([optional] in jsval iid); */
NS_IMETHODIMP nsJSCID::CreateInstance(const JS::Value & iid, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [implicit_jscontext,optional_argc] jsval getService ([optional] in jsval iid); */
NS_IMETHODIMP nsJSCID::GetService(const JS::Value & iid, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
