...
class NS_NO_VTABLE NS_SCRIPTABLE nsIApplicationCacheService : public nsISupports {
 public: 
  ...
  /* nsIApplicationCache createCustomApplicationCache (in ACString group, in nsIFile profileDir, in PRInt32 quota); */
  NS_SCRIPTABLE NS_IMETHOD CreateCustomApplicationCache(const nsACString & group, nsIFile *profileDir, PRInt32 quota, nsIApplicationCache * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIAPPLICATIONCACHESERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateCustomApplicationCache(const nsACString & group, nsIFile *profileDir, PRInt32 quota, nsIApplicationCache * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIAPPLICATIONCACHESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateCustomApplicationCache(const nsACString & group, nsIFile *profileDir, PRInt32 quota, nsIApplicationCache * *_retval NS_OUTPARAM) { return _to CreateCustomApplicationCache(group, profileDir, quota, _retval); } \
...
#define NS_FORWARD_SAFE_NSIAPPLICATIONCACHESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateCustomApplicationCache(const nsACString & group, nsIFile *profileDir, PRInt32 quota, nsIApplicationCache * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateCustomApplicationCache(group, profileDir, quota, _retval); } \
...
/* nsIApplicationCache createCustomApplicationCache (in ACString group, in nsIFile profileDir, in PRInt32 quota); */
NS_IMETHODIMP nsApplicationCacheService::CreateCustomApplicationCache(const nsACString & group, nsIFile *profileDir, PRInt32 quota, nsIApplicationCache * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
