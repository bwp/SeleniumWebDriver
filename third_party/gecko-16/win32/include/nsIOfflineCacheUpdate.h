...
class NS_NO_VTABLE NS_SCRIPTABLE nsIOfflineCacheUpdate : public nsISupports {
 public: 
  ...
  /* void init (in nsIURI aManifestURI, in nsIURI aDocumentURI, in nsIDOMDocument aDocument, [optional] in nsIFile aCustomProfileDir); */
  NS_SCRIPTABLE NS_IMETHOD Init(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIDOMDocument *aDocument, nsIFile *aCustomProfileDir) = 0;
...
#define NS_DECL_NSIOFFLINECACHEUPDATE \
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIDOMDocument *aDocument, nsIFile *aCustomProfileDir); \
...
#define NS_FORWARD_NSIOFFLINECACHEUPDATE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIDOMDocument *aDocument, nsIFile *aCustomProfileDir) { return _to Init(aManifestURI, aDocumentURI, aDocument, aCustomProfileDir); } \
...
#define NS_FORWARD_SAFE_NSIOFFLINECACHEUPDATE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIDOMDocument *aDocument, nsIFile *aCustomProfileDir) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aManifestURI, aDocumentURI, aDocument, aCustomProfileDir); } \
...
/* void init (in nsIURI aManifestURI, in nsIURI aDocumentURI, in nsIDOMDocument aDocument, [optional] in nsIFile aCustomProfileDir); */
NS_IMETHODIMP nsOfflineCacheUpdate::Init(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIDOMDocument *aDocument, nsIFile *aCustomProfileDir)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIOfflineCacheUpdateService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ScheduleCustomProfileUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIFile *aProfileDir, nsIOfflineCacheUpdate * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIOFFLINECACHEUPDATESERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScheduleCustomProfileUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIFile *aProfileDir, nsIOfflineCacheUpdate * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIOFFLINECACHEUPDATESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScheduleCustomProfileUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIFile *aProfileDir, nsIOfflineCacheUpdate * *_retval NS_OUTPARAM) { return _to ScheduleCustomProfileUpdate(aManifestURI, aDocumentURI, aProfileDir, _retval); } \
...
#define NS_FORWARD_SAFE_NSIOFFLINECACHEUPDATESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScheduleCustomProfileUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIFile *aProfileDir, nsIOfflineCacheUpdate * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScheduleCustomProfileUpdate(aManifestURI, aDocumentURI, aProfileDir, _retval); } \
...
/* nsIOfflineCacheUpdate scheduleCustomProfileUpdate (in nsIURI aManifestURI, in nsIURI aDocumentURI, in nsIFile aProfileDir); */
NS_IMETHODIMP nsOfflineCacheUpdateService::ScheduleCustomProfileUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIFile *aProfileDir, nsIOfflineCacheUpdate * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
