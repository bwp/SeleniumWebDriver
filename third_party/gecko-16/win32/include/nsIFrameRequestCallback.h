/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/base/nsIFrameRequestCallback.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFrameRequestCallback : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IFRAMEREQUESTCALLBACK_IID)

  /* void sample (in DOMTimeStamp timeStamp); */
  NS_SCRIPTABLE NS_IMETHOD Sample(DOMTimeStamp timeStamp) = 0;
...
#define NS_DECL_NSIFRAMEREQUESTCALLBACK \
  NS_SCRIPTABLE NS_IMETHOD Sample(DOMTimeStamp timeStamp); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFRAMEREQUESTCALLBACK(_to) \
  NS_SCRIPTABLE NS_IMETHOD Sample(DOMTimeStamp timeStamp) { return _to Sample(timeStamp); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIFRAMEREQUESTCALLBACK(_to) \
  NS_SCRIPTABLE NS_IMETHOD Sample(DOMTimeStamp timeStamp) { return !_to ? NS_ERROR_NULL_POINTER : _to->Sample(timeStamp); } 
