/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/js/xpconnect/idl/xpccomponents.idl
 */
...
#define NS_IXPCCOMPONENTS_UTILS_IID_STR "9e43a260-5db2-11e1-b86c-0800200c9a66"

#define NS_IXPCCOMPONENTS_UTILS_IID \
  {0x9e43a260, 0x5db2, 0x11e1, \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIXPCComponents_Utils : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ForceShrinkingGC(void) = 0;

  /* void schedulePreciseGC (in ScheduledGCCallback callback); */
  NS_SCRIPTABLE NS_IMETHOD SchedulePreciseGC(ScheduledGCCallback *callback) = 0;

  /* void schedulePreciseShrinkingGC (in ScheduledGCCallback callback); */
  NS_SCRIPTABLE NS_IMETHOD SchedulePreciseShrinkingGC(ScheduledGCCallback *callback) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJSTestingFunctions(JSContext* cx, JS::Value *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateArrayIn(const JS::Value & vobj, JSContext* cx, JS::Value *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDeadWrapper(const JS::Value & obj, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStrict_mode(JSContext* cx, bool *aStrict_mode) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetStrict_mode(JSContext* cx, bool aStrict_mode) = 0;
...
#define NS_DECL_NSIXPCCOMPONENTS_UTILS \
  ...
  NS_SCRIPTABLE NS_IMETHOD ForceShrinkingGC(void); \
  NS_SCRIPTABLE NS_IMETHOD SchedulePreciseGC(ScheduledGCCallback *callback); \
  NS_SCRIPTABLE NS_IMETHOD SchedulePreciseShrinkingGC(ScheduledGCCallback *callback); \
  NS_SCRIPTABLE NS_IMETHOD NondeterministicGetWeakMapKeys(const JS::Value & aMap, JSContext* cx, JS::Value *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetJSTestingFunctions(JSContext* cx, JS::Value *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateArrayIn(const JS::Value & vobj, JSContext* cx, JS::Value *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD MakeObjectPropsNormal(const JS::Value & vobj, JSContext* cx); \
  NS_SCRIPTABLE NS_IMETHOD IsDeadWrapper(const JS::Value & obj, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStrict_mode(JSContext* cx, bool *aStrict_mode); \
  NS_SCRIPTABLE NS_IMETHOD SetStrict_mode(JSContext* cx, bool aStrict_mode); \
...
#define NS_FORWARD_NSIXPCCOMPONENTS_UTILS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ForceShrinkingGC(void) { return _to ForceShrinkingGC(); } \
  NS_SCRIPTABLE NS_IMETHOD SchedulePreciseGC(ScheduledGCCallback *callback) { return _to SchedulePreciseGC(callback); } \
  NS_SCRIPTABLE NS_IMETHOD SchedulePreciseShrinkingGC(ScheduledGCCallback *callback) { return _to SchedulePreciseShrinkingGC(callback); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJSTestingFunctions(JSContext* cx, JS::Value *_retval NS_OUTPARAM) { return _to GetJSTestingFunctions(cx, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateArrayIn(const JS::Value & vobj, JSContext* cx, JS::Value *_retval NS_OUTPARAM) { return _to CreateArrayIn(vobj, cx, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD MakeObjectPropsNormal(const JS::Value & vobj, JSContext* cx) { return _to MakeObjectPropsNormal(vobj, cx); } \
  NS_SCRIPTABLE NS_IMETHOD IsDeadWrapper(const JS::Value & obj, bool *_retval NS_OUTPARAM) { return _to IsDeadWrapper(obj, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStrict_mode(JSContext* cx, bool *aStrict_mode) { return _to GetStrict_mode(cx, aStrict_mode); } \
  NS_SCRIPTABLE NS_IMETHOD SetStrict_mode(JSContext* cx, bool aStrict_mode) { return _to SetStrict_mode(cx, aStrict_mode); } \
...
#define NS_FORWARD_SAFE_NSIXPCCOMPONENTS_UTILS(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ForceShrinkingGC(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->ForceShrinkingGC(); } \
  NS_SCRIPTABLE NS_IMETHOD SchedulePreciseGC(ScheduledGCCallback *callback) { return !_to ? NS_ERROR_NULL_POINTER : _to->SchedulePreciseGC(callback); } \
  NS_SCRIPTABLE NS_IMETHOD SchedulePreciseShrinkingGC(ScheduledGCCallback *callback) { return !_to ? NS_ERROR_NULL_POINTER : _to->SchedulePreciseShrinkingGC(callback); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetJSTestingFunctions(JSContext* cx, JS::Value *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetJSTestingFunctions(cx, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateArrayIn(const JS::Value & vobj, JSContext* cx, JS::Value *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateArrayIn(vobj, cx, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD IsDeadWrapper(const JS::Value & obj, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsDeadWrapper(obj, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetStrict_mode(JSContext* cx, bool *aStrict_mode) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetStrict_mode(cx, aStrict_mode); } \
  NS_SCRIPTABLE NS_IMETHOD SetStrict_mode(JSContext* cx, bool aStrict_mode) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetStrict_mode(cx, aStrict_mode); } \
...
/* [implicit_jscontext] jsval getJSTestingFunctions (); */
NS_IMETHODIMP nsXPCComponents_Utils::GetJSTestingFunctions(JSContext* cx, JS::Value *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* [implicit_jscontext] jsval createArrayIn (in jsval vobj); */
NS_IMETHODIMP nsXPCComponents_Utils::CreateArrayIn(const JS::Value & vobj, JSContext* cx, JS::Value *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* bool isDeadWrapper (in jsval obj); */
NS_IMETHODIMP nsXPCComponents_Utils::IsDeadWrapper(const JS::Value & obj, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
