...
#define NS_IDOMMOUSEEVENT_IID_STR "6f4bc64b-1aac-4251-82d3-fd2dc76654a0"

#define NS_IDOMMOUSEEVENT_IID \
  {0x6f4bc64b, 0x1aac, 0x4251, \
    { 0x82, 0xd3, 0xfd, 0x2d, 0xc7, 0x66, 0x54, 0xa0 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMouseEvent : public nsIDOMUIEvent {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozMovementX(PRInt32 *aMozMovementX) = 0;

  /* readonly attribute long mozMovementY; */
  NS_SCRIPTABLE NS_IMETHOD GetMozMovementY(PRInt32 *aMozMovementY) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetButtons(PRUint16 *aButtons) = 0;
...
#define NS_DECL_NSIDOMMOUSEEVENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozMovementX(PRInt32 *aMozMovementX); \
  NS_SCRIPTABLE NS_IMETHOD GetMozMovementY(PRInt32 *aMozMovementY); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetButtons(PRUint16 *aButtons); \
...
#define NS_FORWARD_NSIDOMMOUSEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozMovementX(PRInt32 *aMozMovementX) { return _to GetMozMovementX(aMozMovementX); } \
  NS_SCRIPTABLE NS_IMETHOD GetMozMovementY(PRInt32 *aMozMovementY) { return _to GetMozMovementY(aMozMovementY); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetButtons(PRUint16 *aButtons) { return _to GetButtons(aButtons); } \
...
#define NS_FORWARD_SAFE_NSIDOMMOUSEEVENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozMovementX(PRInt32 *aMozMovementX) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozMovementX(aMozMovementX); } \
  NS_SCRIPTABLE NS_IMETHOD GetMozMovementY(PRInt32 *aMozMovementY) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozMovementY(aMozMovementY); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetButtons(PRUint16 *aButtons) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetButtons(aButtons); } \
...
/* readonly attribute long mozMovementX; */
NS_IMETHODIMP nsDOMMouseEvent::GetMozMovementX(PRInt32 *aMozMovementX)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute long mozMovementY; */
NS_IMETHODIMP nsDOMMouseEvent::GetMozMovementY(PRInt32 *aMozMovementY)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute unsigned short buttons; */
NS_IMETHODIMP nsDOMMouseEvent::GetButtons(PRUint16 *aButtons)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* bool getModifierState (in DOMString keyArg); */
NS_IMETHODIMP nsDOMMouseEvent::GetModifierState(const nsAString & keyArg, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
