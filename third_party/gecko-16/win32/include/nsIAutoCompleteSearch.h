...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAutoCompleteSearchDescriptor : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetSearchType(PRUint16 *aSearchType) = 0;
...
#define NS_DECL_NSIAUTOCOMPLETESEARCHDESCRIPTOR \
  NS_SCRIPTABLE NS_IMETHOD GetSearchType(PRUint16 *aSearchType); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIAUTOCOMPLETESEARCHDESCRIPTOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSearchType(PRUint16 *aSearchType) { return _to GetSearchType(aSearchType); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIAUTOCOMPLETESEARCHDESCRIPTOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSearchType(PRUint16 *aSearchType) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSearchType(aSearchType); } 
...
/* readonly attribute unsigned short searchType; */
NS_IMETHODIMP nsAutoCompleteSearchDescriptor::GetSearchType(PRUint16 *aSearchType)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
