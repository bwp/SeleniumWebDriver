/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/nsIPrintSettings.idl
 */
...
#define NS_IPRINTSETTINGS_IID_STR "4404c94b-0506-4255-9e3c-4582dba6cfbb"

#define NS_IPRINTSETTINGS_IID \
  {0x4404c94b, 0x0506, 0x4255, \
    { 0x9e, 0x3c, 0x45, 0x82, 0xdb, 0xa6, 0xcf, 0xbb }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPrintSettings : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetPageRanges(nsTArray<PRInt32> & aPages) = 0;
...
#define NS_FORWARD_NSIPRINTSETTINGS(_to) \
  ...
  NS_IMETHOD GetPageRanges(nsTArray<PRInt32> & aPages) { return _to GetPageRanges(aPages); } 
...
#define NS_FORWARD_SAFE_NSIPRINTSETTINGS(_to) \
  ...
  NS_IMETHOD GetPageRanges(nsTArray<PRInt32> & aPages) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetPageRanges(aPages); } 
...
/* [noscript] void GetPageRanges (in IntegerArray aPages); */
NS_IMETHODIMP nsPrintSettings::GetPageRanges(nsTArray<PRInt32> & aPages)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
