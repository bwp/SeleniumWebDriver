...
#define NS_IFRAMELOADER_IID_STR "fc338eea-47dc-475e-add7-a3933fcfa07c"

#define NS_IFRAMELOADER_IID \
  {0xfc338eea, 0x47dc, 0x475e, \
    { 0xad, 0xd7, 0xa3, 0x93, 0x3f, 0xcf, 0xa0, 0x7c }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFrameLoader : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetClipSubdocument(bool *aClipSubdocument) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetClipSubdocument(bool aClipSubdocument) = 0;

  /* attribute boolean clampScrollPosition; */
  NS_SCRIPTABLE NS_IMETHOD GetClampScrollPosition(bool *aClampScrollPosition) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetClampScrollPosition(bool aClampScrollPosition) = 0;
...
#define NS_DECL_NSIFRAMELOADER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetClipSubdocument(bool *aClipSubdocument); \
  NS_SCRIPTABLE NS_IMETHOD SetClipSubdocument(bool aClipSubdocument); \
  NS_SCRIPTABLE NS_IMETHOD GetClampScrollPosition(bool *aClampScrollPosition); \
  NS_SCRIPTABLE NS_IMETHOD SetClampScrollPosition(bool aClampScrollPosition); \
...
#define NS_FORWARD_NSIFRAMELOADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetClipSubdocument(bool *aClipSubdocument) { return _to GetClipSubdocument(aClipSubdocument); } \
  NS_SCRIPTABLE NS_IMETHOD SetClipSubdocument(bool aClipSubdocument) { return _to SetClipSubdocument(aClipSubdocument); } \
  NS_SCRIPTABLE NS_IMETHOD GetClampScrollPosition(bool *aClampScrollPosition) { return _to GetClampScrollPosition(aClampScrollPosition); } \
  NS_SCRIPTABLE NS_IMETHOD SetClampScrollPosition(bool aClampScrollPosition) { return _to SetClampScrollPosition(aClampScrollPosition); } \
...
#define NS_FORWARD_SAFE_NSIFRAMELOADER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetClipSubdocument(bool *aClipSubdocument) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetClipSubdocument(aClipSubdocument); } \
  NS_SCRIPTABLE NS_IMETHOD SetClipSubdocument(bool aClipSubdocument) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetClipSubdocument(aClipSubdocument); } \
  NS_SCRIPTABLE NS_IMETHOD GetClampScrollPosition(bool *aClampScrollPosition) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetClampScrollPosition(aClampScrollPosition); } \
  NS_SCRIPTABLE NS_IMETHOD SetClampScrollPosition(bool aClampScrollPosition) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetClampScrollPosition(aClampScrollPosition); } \
