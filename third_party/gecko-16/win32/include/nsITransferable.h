/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/nsITransferable.idl
 */
...
#define NS_ITRANSFERABLE_IID_STR "983cb266-535b-4ca5-8ef2-2cee08d061e6"

#define NS_ITRANSFERABLE_IID \
  {0x983cb266, 0x535b, 0x4ca5, \
    { 0x8e, 0xf2, 0x2c, 0xee, 0x08, 0xd0, 0x61, 0xe6 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITransferable : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsILoadContext *aContext) = 0;
...
#define NS_DECL_NSITRANSFERABLE \
  NS_SCRIPTABLE NS_IMETHOD Init(nsILoadContext *aContext); \
...
#define NS_FORWARD_NSITRANSFERABLE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Init(nsILoadContext *aContext) { return _to Init(aContext); } \
...
#define NS_FORWARD_SAFE_NSITRANSFERABLE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Init(nsILoadContext *aContext) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aContext); } \
