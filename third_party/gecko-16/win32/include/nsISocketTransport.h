...
#define NS_ISOCKETTRANSPORT_IID_STR "704c0859-cb64-43bd-bfdf-c8b28427f812"

#define NS_ISOCKETTRANSPORT_IID \
  {0x704c0859, 0xcb64, 0x43bd, \
    { 0xbf, 0xdf, 0xc8, 0xb2, 0x84, 0x27, 0xf8, 0x12 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsISocketTransport : public nsITransport {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptablePeerAddr(nsINetAddr * *_retval NS_OUTPARAM) = 0;

  /* nsINetAddr getScriptableSelfAddr (); */
  NS_SCRIPTABLE NS_IMETHOD GetScriptableSelfAddr(nsINetAddr * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISOCKETTRANSPORT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptablePeerAddr(nsINetAddr * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetScriptableSelfAddr(nsINetAddr * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSISOCKETTRANSPORT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptablePeerAddr(nsINetAddr * *_retval NS_OUTPARAM) { return _to GetScriptablePeerAddr(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetScriptableSelfAddr(nsINetAddr * *_retval NS_OUTPARAM) { return _to GetScriptableSelfAddr(_retval); } \
...
#define NS_FORWARD_SAFE_NSISOCKETTRANSPORT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptablePeerAddr(nsINetAddr * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScriptablePeerAddr(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetScriptableSelfAddr(nsINetAddr * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScriptableSelfAddr(_retval); } \
...
/* nsINetAddr getScriptablePeerAddr (); */
NS_IMETHODIMP nsSocketTransport::GetScriptablePeerAddr(nsINetAddr * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsINetAddr getScriptableSelfAddr (); */
NS_IMETHODIMP nsSocketTransport::GetScriptableSelfAddr(nsINetAddr * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
