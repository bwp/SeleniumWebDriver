...
#define NS_IDEVICESENSORS_IID_STR "83306c9f-1c8f-43c4-900a-245d7f219511"

#define NS_IDEVICESENSORS_IID \
  {0x83306c9f, 0x1c8f, 0x43c4, \
    { 0x90, 0x0a, 0x24, 0x5d, 0x7f, 0x21, 0x95, 0x11 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDeviceSensors : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ListenerCount(PRUint32 aType, PRInt32 *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDEVICESENSORS \
  NS_SCRIPTABLE NS_IMETHOD ListenerCount(PRUint32 aType, PRInt32 *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDEVICESENSORS(_to) \
  NS_SCRIPTABLE NS_IMETHOD ListenerCount(PRUint32 aType, PRInt32 *_retval NS_OUTPARAM) { return _to ListenerCount(aType, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDEVICESENSORS(_to) \
  NS_SCRIPTABLE NS_IMETHOD ListenerCount(PRUint32 aType, PRInt32 *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ListenerCount(aType, _retval); } \
...
/* long listenerCount (in unsigned long aType); */
NS_IMETHODIMP nsDeviceSensors::ListenerCount(PRUint32 aType, PRInt32 *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
