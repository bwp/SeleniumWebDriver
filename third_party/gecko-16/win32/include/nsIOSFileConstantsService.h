/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/system/nsIOSFileConstantsService.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIOSFileConstantsService : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IOSFILECONSTANTSSERVICE_IID)

  /* [implicit_jscontext] void init (); */
  NS_SCRIPTABLE NS_IMETHOD Init(JSContext* cx) = 0;
...
#define NS_DECL_NSIOSFILECONSTANTSSERVICE \
  NS_SCRIPTABLE NS_IMETHOD Init(JSContext* cx); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIOSFILECONSTANTSSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Init(JSContext* cx) { return _to Init(cx); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIOSFILECONSTANTSSERVICE(_to) \
  NS_SCRIPTABLE NS_IMETHOD Init(JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(cx); } 
