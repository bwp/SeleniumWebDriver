/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/battery/nsINavigatorBattery.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsINavigatorBattery : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_INAVIGATORBATTERY_IID)

  /* readonly attribute nsIDOMBatteryManager battery; */
  NS_SCRIPTABLE NS_IMETHOD GetBattery(nsIDOMBatteryManager * *aBattery) = 0;
...
#define NS_DECL_NSINAVIGATORBATTERY \
  NS_SCRIPTABLE NS_IMETHOD GetBattery(nsIDOMBatteryManager * *aBattery); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSINAVIGATORBATTERY(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetBattery(nsIDOMBatteryManager * *aBattery) { return _to GetBattery(aBattery); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSINAVIGATORBATTERY(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetBattery(nsIDOMBatteryManager * *aBattery) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetBattery(aBattery); } 
