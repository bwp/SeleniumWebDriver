...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGTransform : public nsISupports {
 public: 
  ...
  enum {
    SVG_TRANSFORM_UNKNOWN = 0U,
    SVG_TRANSFORM_MATRIX = 1U,
    SVG_TRANSFORM_TRANSLATE = 2U,
    SVG_TRANSFORM_SCALE = 3U,
    SVG_TRANSFORM_ROTATE = 4U,
    SVG_TRANSFORM_SKEWX = 5U,
    SVG_TRANSFORM_SKEWY = 6U
  };
