/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/base/nsIDOMDOMError.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMDOMError : public nsISupports {
 public: 
