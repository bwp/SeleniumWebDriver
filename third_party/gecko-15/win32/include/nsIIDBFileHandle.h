/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/indexedDB/nsIIDBFileHandle.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIIDBFileHandle : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IIDBFILEHANDLE_IID)

  /* readonly attribute nsIIDBDatabase database; */
  NS_SCRIPTABLE NS_IMETHOD GetDatabase(nsIIDBDatabase * *aDatabase) = 0;
...
#define NS_DECL_NSIIDBFILEHANDLE \
  NS_SCRIPTABLE NS_IMETHOD GetDatabase(nsIIDBDatabase * *aDatabase); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIIDBFILEHANDLE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetDatabase(nsIIDBDatabase * *aDatabase) { return _to GetDatabase(aDatabase); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIIDBFILEHANDLE(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetDatabase(nsIIDBDatabase * *aDatabase) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDatabase(aDatabase); } 
