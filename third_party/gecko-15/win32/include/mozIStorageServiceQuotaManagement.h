...
#define MOZISTORAGESERVICEQUOTAMANAGEMENT_IID_STR "4d81faf5-fe01-428b-99b8-c94cba12fd72"

#define MOZISTORAGESERVICEQUOTAMANAGEMENT_IID \
  {0x4d81faf5, 0xfe01, 0x428b, \
    { 0x99, 0xb8, 0xc9, 0x4c, 0xba, 0x12, 0xfd, 0x72 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE mozIStorageServiceQuotaManagement : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateQuotaInformationForFile(nsIFile *aFile) = 0;
...
#define NS_DECL_MOZISTORAGESERVICEQUOTAMANAGEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateQuotaInformationForFile(nsIFile *aFile); 
...
#define NS_FORWARD_MOZISTORAGESERVICEQUOTAMANAGEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateQuotaInformationForFile(nsIFile *aFile) { return _to UpdateQuotaInformationForFile(aFile); } 
...
#define NS_FORWARD_SAFE_MOZISTORAGESERVICEQUOTAMANAGEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD UpdateQuotaInformationForFile(nsIFile *aFile) { return !_to ? NS_ERROR_NULL_POINTER : _to->UpdateQuotaInformationForFile(aFile); } 
...
/* void updateQuotaInformationForFile (in nsIFile aFile); */
NS_IMETHODIMP _MYCLASS_::UpdateQuotaInformationForFile(nsIFile *aFile)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
