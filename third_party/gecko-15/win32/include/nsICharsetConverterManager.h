...
class NS_NO_VTABLE NS_SCRIPTABLE nsICharsetConverterManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetAlias(const char * aCharset, nsACString & _retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetTitle(const char * aCharset, nsAString & _retval NS_OUTPARAM) = 0;

  /* AString getCharsetData (in string aCharset, in wstring aProp); */
  NS_SCRIPTABLE NS_IMETHOD GetCharsetData(const char * aCharset, const PRUnichar * aProp, nsAString & _retval NS_OUTPARAM) = 0;

  /* nsIAtom getCharsetLangGroup (in string aCharset); */
  NS_SCRIPTABLE NS_IMETHOD GetCharsetLangGroup(const char * aCharset, nsIAtom * *_retval NS_OUTPARAM) = 0;

  /* nsIAtom getCharsetLangGroupRaw (in string aCharset); */
  NS_SCRIPTABLE NS_IMETHOD GetCharsetLangGroupRaw(const char * aCharset, nsIAtom * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSICHARSETCONVERTERMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetAlias(const char * aCharset, nsACString & _retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetTitle(const char * aCharset, nsAString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetCharsetData(const char * aCharset, const PRUnichar * aProp, nsAString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetCharsetLangGroup(const char * aCharset, nsIAtom * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD GetCharsetLangGroupRaw(const char * aCharset, nsIAtom * *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSICHARSETCONVERTERMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetAlias(const char * aCharset, nsACString & _retval NS_OUTPARAM) { return _to GetCharsetAlias(aCharset, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetTitle(const char * aCharset, nsAString & _retval NS_OUTPARAM) { return _to GetCharsetTitle(aCharset, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCharsetData(const char * aCharset, const PRUnichar * aProp, nsAString & _retval NS_OUTPARAM) { return _to GetCharsetData(aCharset, aProp, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCharsetLangGroup(const char * aCharset, nsIAtom * *_retval NS_OUTPARAM) { return _to GetCharsetLangGroup(aCharset, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCharsetLangGroupRaw(const char * aCharset, nsIAtom * *_retval NS_OUTPARAM) { return _to GetCharsetLangGroupRaw(aCharset, _retval); } 
...
#define NS_FORWARD_SAFE_NSICHARSETCONVERTERMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetAlias(const char * aCharset, nsACString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetAlias(aCharset, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCharsetTitle(const char * aCharset, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetTitle(aCharset, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCharsetData(const char * aCharset, const PRUnichar * aProp, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetData(aCharset, aProp, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCharsetLangGroup(const char * aCharset, nsIAtom * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetLangGroup(aCharset, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD GetCharsetLangGroupRaw(const char * aCharset, nsIAtom * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCharsetLangGroupRaw(aCharset, _retval); } 
...
/* ACString getCharsetAlias (in string aCharset); */
NS_IMETHODIMP nsCharsetConverterManager::GetCharsetAlias(const char * aCharset, nsACString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* AString getCharsetTitle (in string aCharset); */
NS_IMETHODIMP nsCharsetConverterManager::GetCharsetTitle(const char * aCharset, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* AString getCharsetData (in string aCharset, in wstring aProp); */
NS_IMETHODIMP nsCharsetConverterManager::GetCharsetData(const char * aCharset, const PRUnichar * aProp, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIAtom getCharsetLangGroup (in string aCharset); */
NS_IMETHODIMP nsCharsetConverterManager::GetCharsetLangGroup(const char * aCharset, nsIAtom * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIAtom getCharsetLangGroupRaw (in string aCharset); */
NS_IMETHODIMP nsCharsetConverterManager::GetCharsetLangGroupRaw(const char * aCharset, nsIAtom * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
