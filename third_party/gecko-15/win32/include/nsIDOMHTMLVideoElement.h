...
#define NS_IDOMHTMLVIDEOELEMENT_IID_STR "e43f61e3-9c67-4e78-8534-3399d7f192b9"

#define NS_IDOMHTMLVIDEOELEMENT_IID \
  {0xe43f61e3, 0x9c67, 0x4e78, \
    { 0x85, 0x34, 0x33, 0x99, 0xd7, 0xf1, 0x92, 0xb9 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMHTMLVideoElement : public nsIDOMHTMLMediaElement {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozHasAudio(bool *aMozHasAudio) = 0;
...
#define NS_DECL_NSIDOMHTMLVIDEOELEMENT \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozHasAudio(bool *aMozHasAudio); 
...
#define NS_FORWARD_NSIDOMHTMLVIDEOELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozHasAudio(bool *aMozHasAudio) { return _to GetMozHasAudio(aMozHasAudio); } 
...
#define NS_FORWARD_SAFE_NSIDOMHTMLVIDEOELEMENT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetMozHasAudio(bool *aMozHasAudio) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozHasAudio(aMozHasAudio); } 
