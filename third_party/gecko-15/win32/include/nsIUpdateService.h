...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUpdate : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetShowPrompt(bool *aShowPrompt) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetShowPrompt(bool aShowPrompt) = 0;

  /* attribute boolean showNeverForVersion; */
  NS_SCRIPTABLE NS_IMETHOD GetShowNeverForVersion(bool *aShowNeverForVersion) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetShowNeverForVersion(bool aShowNeverForVersion) = 0;

  /* attribute boolean showSurvey; */
  NS_SCRIPTABLE NS_IMETHOD GetShowSurvey(bool *aShowSurvey) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetShowSurvey(bool aShowSurvey) = 0;

  /* attribute boolean isCompleteUpdate; */
  NS_SCRIPTABLE NS_IMETHOD GetIsCompleteUpdate(bool *aIsCompleteUpdate) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetIsCompleteUpdate(bool aIsCompleteUpdate) = 0;

  /* attribute boolean isSecurityUpdate; */
  NS_SCRIPTABLE NS_IMETHOD GetIsSecurityUpdate(bool *aIsSecurityUpdate) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetIsSecurityUpdate(bool aIsSecurityUpdate) = 0;
...
#define NS_DECL_NSIUPDATE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetShowPrompt(bool *aShowPrompt); \
  NS_SCRIPTABLE NS_IMETHOD SetShowPrompt(bool aShowPrompt); \
  NS_SCRIPTABLE NS_IMETHOD GetShowNeverForVersion(bool *aShowNeverForVersion); \
  NS_SCRIPTABLE NS_IMETHOD SetShowNeverForVersion(bool aShowNeverForVersion); \
  NS_SCRIPTABLE NS_IMETHOD GetShowSurvey(bool *aShowSurvey); \
  NS_SCRIPTABLE NS_IMETHOD SetShowSurvey(bool aShowSurvey); \
  NS_SCRIPTABLE NS_IMETHOD GetIsCompleteUpdate(bool *aIsCompleteUpdate); \
  NS_SCRIPTABLE NS_IMETHOD SetIsCompleteUpdate(bool aIsCompleteUpdate); \
  NS_SCRIPTABLE NS_IMETHOD GetIsSecurityUpdate(bool *aIsSecurityUpdate); \
  NS_SCRIPTABLE NS_IMETHOD SetIsSecurityUpdate(bool aIsSecurityUpdate); \
...
#define NS_FORWARD_NSIUPDATE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetShowPrompt(bool *aShowPrompt) { return _to GetShowPrompt(aShowPrompt); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowPrompt(bool aShowPrompt) { return _to SetShowPrompt(aShowPrompt); } \
  NS_SCRIPTABLE NS_IMETHOD GetShowNeverForVersion(bool *aShowNeverForVersion) { return _to GetShowNeverForVersion(aShowNeverForVersion); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowNeverForVersion(bool aShowNeverForVersion) { return _to SetShowNeverForVersion(aShowNeverForVersion); } \
  NS_SCRIPTABLE NS_IMETHOD GetShowSurvey(bool *aShowSurvey) { return _to GetShowSurvey(aShowSurvey); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowSurvey(bool aShowSurvey) { return _to SetShowSurvey(aShowSurvey); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsCompleteUpdate(bool *aIsCompleteUpdate) { return _to GetIsCompleteUpdate(aIsCompleteUpdate); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsCompleteUpdate(bool aIsCompleteUpdate) { return _to SetIsCompleteUpdate(aIsCompleteUpdate); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsSecurityUpdate(bool *aIsSecurityUpdate) { return _to GetIsSecurityUpdate(aIsSecurityUpdate); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsSecurityUpdate(bool aIsSecurityUpdate) { return _to SetIsSecurityUpdate(aIsSecurityUpdate); } \
...
#define NS_FORWARD_SAFE_NSIUPDATE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetShowPrompt(bool *aShowPrompt) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetShowPrompt(aShowPrompt); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowPrompt(bool aShowPrompt) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetShowPrompt(aShowPrompt); } \
  NS_SCRIPTABLE NS_IMETHOD GetShowNeverForVersion(bool *aShowNeverForVersion) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetShowNeverForVersion(aShowNeverForVersion); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowNeverForVersion(bool aShowNeverForVersion) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetShowNeverForVersion(aShowNeverForVersion); } \
  NS_SCRIPTABLE NS_IMETHOD GetShowSurvey(bool *aShowSurvey) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetShowSurvey(aShowSurvey); } \
  NS_SCRIPTABLE NS_IMETHOD SetShowSurvey(bool aShowSurvey) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetShowSurvey(aShowSurvey); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsCompleteUpdate(bool *aIsCompleteUpdate) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsCompleteUpdate(aIsCompleteUpdate); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsCompleteUpdate(bool aIsCompleteUpdate) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsCompleteUpdate(aIsCompleteUpdate); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsSecurityUpdate(bool *aIsSecurityUpdate) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsSecurityUpdate(aIsSecurityUpdate); } \
  NS_SCRIPTABLE NS_IMETHOD SetIsSecurityUpdate(bool aIsSecurityUpdate) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetIsSecurityUpdate(aIsSecurityUpdate); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUpdateChecker : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CheckForUpdates(nsIUpdateCheckListener *listener, bool force) = 0;
...
#define NS_DECL_NSIUPDATECHECKER \
  NS_SCRIPTABLE NS_IMETHOD CheckForUpdates(nsIUpdateCheckListener *listener, bool force); \
  NS_SCRIPTABLE NS_IMETHOD StopChecking(PRUint16 duration); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIUPDATECHECKER(_to) \
  NS_SCRIPTABLE NS_IMETHOD CheckForUpdates(nsIUpdateCheckListener *listener, bool force) { return _to CheckForUpdates(listener, force); } \
...
#define NS_FORWARD_SAFE_NSIUPDATECHECKER(_to) \
  NS_SCRIPTABLE NS_IMETHOD CheckForUpdates(nsIUpdateCheckListener *listener, bool force) { return !_to ? NS_ERROR_NULL_POINTER : _to->CheckForUpdates(listener, force); } \
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIApplicationUpdateService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD DownloadUpdate(nsIUpdate *update, bool background, nsAString & _retval NS_OUTPARAM) = 0;

  /* void applyUpdateInBackground (in nsIUpdate update); */
  NS_SCRIPTABLE NS_IMETHOD ApplyUpdateInBackground(nsIUpdate *update) = 0;

  /* nsIFile getUpdatesDirectory (); */
  NS_SCRIPTABLE NS_IMETHOD GetUpdatesDirectory(nsIFile * *_retval NS_OUTPARAM) = 0;

  /* void pauseDownload (); */
  NS_SCRIPTABLE NS_IMETHOD PauseDownload(void) = 0;

  /* readonly attribute boolean isDownloading; */
  NS_SCRIPTABLE NS_IMETHOD GetIsDownloading(bool *aIsDownloading) = 0;

  /* readonly attribute boolean canCheckForUpdates; */
  NS_SCRIPTABLE NS_IMETHOD GetCanCheckForUpdates(bool *aCanCheckForUpdates) = 0;

  /* readonly attribute boolean canApplyUpdates; */
  NS_SCRIPTABLE NS_IMETHOD GetCanApplyUpdates(bool *aCanApplyUpdates) = 0;

  /* readonly attribute boolean canStageUpdates; */
  NS_SCRIPTABLE NS_IMETHOD GetCanStageUpdates(bool *aCanStageUpdates) = 0;
...
#define NS_DECL_NSIAPPLICATIONUPDATESERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD DownloadUpdate(nsIUpdate *update, bool background, nsAString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD ApplyUpdateInBackground(nsIUpdate *update); \
  NS_SCRIPTABLE NS_IMETHOD GetUpdatesDirectory(nsIFile * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD PauseDownload(void); \
  NS_SCRIPTABLE NS_IMETHOD GetIsDownloading(bool *aIsDownloading); \
  NS_SCRIPTABLE NS_IMETHOD GetCanCheckForUpdates(bool *aCanCheckForUpdates); \
  NS_SCRIPTABLE NS_IMETHOD GetCanApplyUpdates(bool *aCanApplyUpdates); \
  NS_SCRIPTABLE NS_IMETHOD GetCanStageUpdates(bool *aCanStageUpdates); 
...
#define NS_FORWARD_NSIAPPLICATIONUPDATESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD DownloadUpdate(nsIUpdate *update, bool background, nsAString & _retval NS_OUTPARAM) { return _to DownloadUpdate(update, background, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ApplyUpdateInBackground(nsIUpdate *update) { return _to ApplyUpdateInBackground(update); } \
  NS_SCRIPTABLE NS_IMETHOD GetUpdatesDirectory(nsIFile * *_retval NS_OUTPARAM) { return _to GetUpdatesDirectory(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD PauseDownload(void) { return _to PauseDownload(); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsDownloading(bool *aIsDownloading) { return _to GetIsDownloading(aIsDownloading); } \
  NS_SCRIPTABLE NS_IMETHOD GetCanCheckForUpdates(bool *aCanCheckForUpdates) { return _to GetCanCheckForUpdates(aCanCheckForUpdates); } \
  NS_SCRIPTABLE NS_IMETHOD GetCanApplyUpdates(bool *aCanApplyUpdates) { return _to GetCanApplyUpdates(aCanApplyUpdates); } \
  NS_SCRIPTABLE NS_IMETHOD GetCanStageUpdates(bool *aCanStageUpdates) { return _to GetCanStageUpdates(aCanStageUpdates); } 
...
#define NS_FORWARD_SAFE_NSIAPPLICATIONUPDATESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD DownloadUpdate(nsIUpdate *update, bool background, nsAString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->DownloadUpdate(update, background, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD ApplyUpdateInBackground(nsIUpdate *update) { return !_to ? NS_ERROR_NULL_POINTER : _to->ApplyUpdateInBackground(update); } \
  NS_SCRIPTABLE NS_IMETHOD GetUpdatesDirectory(nsIFile * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUpdatesDirectory(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD PauseDownload(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->PauseDownload(); } \
  NS_SCRIPTABLE NS_IMETHOD GetIsDownloading(bool *aIsDownloading) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetIsDownloading(aIsDownloading); } \
  NS_SCRIPTABLE NS_IMETHOD GetCanCheckForUpdates(bool *aCanCheckForUpdates) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCanCheckForUpdates(aCanCheckForUpdates); } \
  NS_SCRIPTABLE NS_IMETHOD GetCanApplyUpdates(bool *aCanApplyUpdates) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCanApplyUpdates(aCanApplyUpdates); } \
  NS_SCRIPTABLE NS_IMETHOD GetCanStageUpdates(bool *aCanStageUpdates) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCanStageUpdates(aCanStageUpdates); } 
...
/* AString downloadUpdate (in nsIUpdate update, in boolean background); */
NS_IMETHODIMP nsApplicationUpdateService::DownloadUpdate(nsIUpdate *update, bool background, nsAString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* nsIFile getUpdatesDirectory (); */
NS_IMETHODIMP nsApplicationUpdateService::GetUpdatesDirectory(nsIFile * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUpdateProcessor : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IUPDATEPROCESSOR_IID)

  /* void processUpdate (in nsIUpdate update); */
  NS_SCRIPTABLE NS_IMETHOD ProcessUpdate(nsIUpdate *update) = 0;
...
#define NS_DECL_NSIUPDATEPROCESSOR \
  NS_SCRIPTABLE NS_IMETHOD ProcessUpdate(nsIUpdate *update); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIUPDATEPROCESSOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD ProcessUpdate(nsIUpdate *update) { return _to ProcessUpdate(update); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIUPDATEPROCESSOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD ProcessUpdate(nsIUpdate *update) { return !_to ? NS_ERROR_NULL_POINTER : _to->ProcessUpdate(update); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUpdateManager : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD RefreshUpdateStatus(nsIUpdate *update) = 0;
...
#define NS_DECL_NSIUPDATEMANAGER \
  ...
  NS_SCRIPTABLE NS_IMETHOD RefreshUpdateStatus(nsIUpdate *update); 
...
#define NS_FORWARD_NSIUPDATEMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RefreshUpdateStatus(nsIUpdate *update) { return _to RefreshUpdateStatus(update); } 
...
#define NS_FORWARD_SAFE_NSIUPDATEMANAGER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD RefreshUpdateStatus(nsIUpdate *update) { return !_to ? NS_ERROR_NULL_POINTER : _to->RefreshUpdateStatus(update); } 
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIUpdatePrompt : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD ShowUpdateDownloaded(nsIUpdate *update, bool background) = 0;
...
#define NS_DECL_NSIUPDATEPROMPT \
  ...
  NS_SCRIPTABLE NS_IMETHOD ShowUpdateDownloaded(nsIUpdate *update, bool background); \
...
#define NS_FORWARD_NSIUPDATEPROMPT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ShowUpdateDownloaded(nsIUpdate *update, bool background) { return _to ShowUpdateDownloaded(update, background); } \
...
#define NS_FORWARD_SAFE_NSIUPDATEPROMPT(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ShowUpdateDownloaded(nsIUpdate *update, bool background) { return !_to ? NS_ERROR_NULL_POINTER : _to->ShowUpdateDownloaded(update, background); } \
