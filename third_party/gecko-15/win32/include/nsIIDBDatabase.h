...
#define NS_IIDBDATABASE_IID_STR "4543dbad-2b37-4741-8729-73b08b7ee37e"

#define NS_IIDBDATABASE_IID \
  {0x4543dbad, 0x2b37, 0x4741, \
    { 0x87, 0x29, 0x73, 0xb0, 0x8b, 0x7e, 0xe3, 0x7e }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIIDBDatabase : public nsISupports {
 public: 
  ...
  /* nsIIDBRequest mozCreateFileHandle (in DOMString name, [optional] in DOMString type); */
  NS_SCRIPTABLE NS_IMETHOD MozCreateFileHandle(const nsAString & name, const nsAString & type, nsIIDBRequest * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIIDBDATABASE \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozCreateFileHandle(const nsAString & name, const nsAString & type, nsIIDBRequest * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIIDBDATABASE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozCreateFileHandle(const nsAString & name, const nsAString & type, nsIIDBRequest * *_retval NS_OUTPARAM) { return _to MozCreateFileHandle(name, type, _retval); } \
...
#define NS_FORWARD_SAFE_NSIIDBDATABASE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozCreateFileHandle(const nsAString & name, const nsAString & type, nsIIDBRequest * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozCreateFileHandle(name, type, _retval); } \
...
/* nsIIDBRequest mozCreateFileHandle (in DOMString name, [optional] in DOMString type); */
NS_IMETHODIMP nsIDBDatabase::MozCreateFileHandle(const nsAString & name, const nsAString & type, nsIIDBRequest * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
