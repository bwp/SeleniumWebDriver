...
#define NS_IDOMWINDOW_IID_STR "a1af6cd9-c6e7-4037-99f8-dbca1b03e345"

#define NS_IDOMWINDOW_IID \
  {0xa1af6cd9, 0xc6e7, 0x4037, \
    { 0x99, 0xf8, 0xdb, 0xca, 0x1b, 0x03, 0xe3, 0x45 }}

class NS_SCRIPTABLE nsIDOMWindow : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptableTop(nsIDOMWindow * *aTop) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptableParent(nsIDOMWindow * *aParent) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptableFrameElement(nsIDOMElement * *aFrameElement) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD MozRequestAnimationFrame(nsIFrameRequestCallback *aCallback, PRInt32 *_retval NS_OUTPARAM) = 0;

  /* void mozCancelAnimationFrame (in long aHandle); */
  NS_SCRIPTABLE NS_IMETHOD MozCancelAnimationFrame(PRInt32 aHandle) = 0;

  /* void mozCancelRequestAnimationFrame (in long aHandle); */
  NS_SCRIPTABLE NS_IMETHOD MozCancelRequestAnimationFrame(PRInt32 aHandle) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOndeviceproximity(JSContext* cx, JS::Value *aOndeviceproximity) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetOndeviceproximity(JSContext* cx, const JS::Value & aOndeviceproximity) = 0;

  /* [implicit_jscontext] attribute jsval onuserproximity; */
  NS_SCRIPTABLE NS_IMETHOD GetOnuserproximity(JSContext* cx, JS::Value *aOnuserproximity) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetOnuserproximity(JSContext* cx, const JS::Value & aOnuserproximity) = 0;

  /* [implicit_jscontext] attribute jsval ondevicelight; */
  NS_SCRIPTABLE NS_IMETHOD GetOndevicelight(JSContext* cx, JS::Value *aOndevicelight) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetOndevicelight(JSContext* cx, const JS::Value & aOndevicelight) = 0;
...
#define NS_DECL_NSIDOMWINDOW \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptableTop(nsIDOMWindow * *aTop); \
  NS_IMETHOD GetRealTop(nsIDOMWindow * *aRealTop); \
  NS_SCRIPTABLE NS_IMETHOD GetScriptableParent(nsIDOMWindow * *aParent); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptableFrameElement(nsIDOMElement * *aFrameElement); \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozRequestAnimationFrame(nsIFrameRequestCallback *aCallback, PRInt32 *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD MozCancelAnimationFrame(PRInt32 aHandle); \
  NS_SCRIPTABLE NS_IMETHOD MozCancelRequestAnimationFrame(PRInt32 aHandle); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOndeviceproximity(JSContext* cx, JS::Value *aOndeviceproximity); \
  NS_SCRIPTABLE NS_IMETHOD SetOndeviceproximity(JSContext* cx, const JS::Value & aOndeviceproximity); \
  NS_SCRIPTABLE NS_IMETHOD GetOnuserproximity(JSContext* cx, JS::Value *aOnuserproximity); \
  NS_SCRIPTABLE NS_IMETHOD SetOnuserproximity(JSContext* cx, const JS::Value & aOnuserproximity); \
  NS_SCRIPTABLE NS_IMETHOD GetOndevicelight(JSContext* cx, JS::Value *aOndevicelight); \
  NS_SCRIPTABLE NS_IMETHOD SetOndevicelight(JSContext* cx, const JS::Value & aOndevicelight); \
...
#define NS_FORWARD_NSIDOMWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptableTop(nsIDOMWindow * *aTop) { return _to GetScriptableTop(aTop); } \
  NS_IMETHOD GetRealTop(nsIDOMWindow * *aRealTop) { return _to GetRealTop(aRealTop); } \
  NS_SCRIPTABLE NS_IMETHOD GetScriptableParent(nsIDOMWindow * *aParent) { return _to GetScriptableParent(aParent); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptableFrameElement(nsIDOMElement * *aFrameElement) { return _to GetScriptableFrameElement(aFrameElement); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozRequestAnimationFrame(nsIFrameRequestCallback *aCallback, PRInt32 *_retval NS_OUTPARAM) { return _to MozRequestAnimationFrame(aCallback, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD MozCancelAnimationFrame(PRInt32 aHandle) { return _to MozCancelAnimationFrame(aHandle); } \
  NS_SCRIPTABLE NS_IMETHOD MozCancelRequestAnimationFrame(PRInt32 aHandle) { return _to MozCancelRequestAnimationFrame(aHandle); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOndeviceproximity(JSContext* cx, JS::Value *aOndeviceproximity) { return _to GetOndeviceproximity(cx, aOndeviceproximity); } \
  NS_SCRIPTABLE NS_IMETHOD SetOndeviceproximity(JSContext* cx, const JS::Value & aOndeviceproximity) { return _to SetOndeviceproximity(cx, aOndeviceproximity); } \
  NS_SCRIPTABLE NS_IMETHOD GetOnuserproximity(JSContext* cx, JS::Value *aOnuserproximity) { return _to GetOnuserproximity(cx, aOnuserproximity); } \
  NS_SCRIPTABLE NS_IMETHOD SetOnuserproximity(JSContext* cx, const JS::Value & aOnuserproximity) { return _to SetOnuserproximity(cx, aOnuserproximity); } \
  NS_SCRIPTABLE NS_IMETHOD GetOndevicelight(JSContext* cx, JS::Value *aOndevicelight) { return _to GetOndevicelight(cx, aOndevicelight); } \
  NS_SCRIPTABLE NS_IMETHOD SetOndevicelight(JSContext* cx, const JS::Value & aOndevicelight) { return _to SetOndevicelight(cx, aOndevicelight); } \
...
#define NS_FORWARD_SAFE_NSIDOMWINDOW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptableTop(nsIDOMWindow * *aTop) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScriptableTop(aTop); } \
  NS_IMETHOD GetRealTop(nsIDOMWindow * *aRealTop) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRealTop(aRealTop); } \
  NS_SCRIPTABLE NS_IMETHOD GetScriptableParent(nsIDOMWindow * *aParent) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScriptableParent(aParent); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetScriptableFrameElement(nsIDOMElement * *aFrameElement) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetScriptableFrameElement(aFrameElement); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD MozRequestAnimationFrame(nsIFrameRequestCallback *aCallback, PRInt32 *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozRequestAnimationFrame(aCallback, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD MozCancelAnimationFrame(PRInt32 aHandle) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozCancelAnimationFrame(aHandle); } \
  NS_SCRIPTABLE NS_IMETHOD MozCancelRequestAnimationFrame(PRInt32 aHandle) { return !_to ? NS_ERROR_NULL_POINTER : _to->MozCancelRequestAnimationFrame(aHandle); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetOndeviceproximity(JSContext* cx, JS::Value *aOndeviceproximity) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOndeviceproximity(cx, aOndeviceproximity); } \
  NS_SCRIPTABLE NS_IMETHOD SetOndeviceproximity(JSContext* cx, const JS::Value & aOndeviceproximity) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOndeviceproximity(cx, aOndeviceproximity); } \
  NS_SCRIPTABLE NS_IMETHOD GetOnuserproximity(JSContext* cx, JS::Value *aOnuserproximity) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOnuserproximity(cx, aOnuserproximity); } \
  NS_SCRIPTABLE NS_IMETHOD SetOnuserproximity(JSContext* cx, const JS::Value & aOnuserproximity) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOnuserproximity(cx, aOnuserproximity); } \
  NS_SCRIPTABLE NS_IMETHOD GetOndevicelight(JSContext* cx, JS::Value *aOndevicelight) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetOndevicelight(cx, aOndevicelight); } \
  NS_SCRIPTABLE NS_IMETHOD SetOndevicelight(JSContext* cx, const JS::Value & aOndevicelight) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOndevicelight(cx, aOndevicelight); } \
...
/* long mozRequestAnimationFrame ([optional] in nsIFrameRequestCallback aCallback); */
NS_IMETHODIMP nsDOMWindow::MozRequestAnimationFrame(nsIFrameRequestCallback *aCallback, PRInt32 *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void mozCancelAnimationFrame (in long aHandle); */
NS_IMETHODIMP nsDOMWindow::MozCancelAnimationFrame(PRInt32 aHandle)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void mozCancelRequestAnimationFrame (in long aHandle); */
NS_IMETHODIMP nsDOMWindow::MozCancelRequestAnimationFrame(PRInt32 aHandle)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
