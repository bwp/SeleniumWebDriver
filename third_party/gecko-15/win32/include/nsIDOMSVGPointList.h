...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGPointList : public nsISupports {
 public: 
  ...
  /* [getter,noscript,nostdcall,notxpcom] nsIDOMSVGPoint getItemAt (in unsigned long index); */
  virtual nsIDOMSVGPoint * GetItemAt(PRUint32 index) = 0;
...
#define NS_DECL_NSIDOMSVGPOINTLIST \
  ...
  virtual nsIDOMSVGPoint * GetItemAt(PRUint32 index); \
...
#define NS_FORWARD_NSIDOMSVGPOINTLIST(_to) \
  ...
  virtual nsIDOMSVGPoint * GetItemAt(PRUint32 index) { return _to GetItemAt(index); } \
...
#define NS_FORWARD_SAFE_NSIDOMSVGPOINTLIST(_to) \
  ...
  virtual nsIDOMSVGPoint * GetItemAt(PRUint32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItemAt(index); } \
...
/* [getter,noscript,nostdcall,notxpcom] nsIDOMSVGPoint getItemAt (in unsigned long index); */
nsIDOMSVGPoint * nsDOMSVGPointList::GetItemAt(PRUint32 index)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
