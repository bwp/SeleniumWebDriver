/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/js/xpconnect/idl/xpcIJSModuleLoader.idl
 */
...
/* [implicit_jscontext,optional_argc] jsval import (in AUTF8String aResourceURI, [optional] in jsval targetObj); */
NS_IMETHODIMP _MYCLASS_::Import(const nsACString & aResourceURI, const JS::Value & targetObj, JSContext* cx, PRUint8 _argc, JS::Value *_retval NS_OUTPARAM)
{
