...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFileStream : public nsISupports {
 public: 
...
/* void init (in nsIFile file, in long ioFlags, in long perm, in long behaviorFlags); */
NS_IMETHODIMP nsFileStream::Init(nsIFile *file, PRInt32 ioFlags, PRInt32 perm, PRInt32 behaviorFlags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFileMetadata : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLastModified(PRInt64 *aLastModified) = 0;
...
#define NS_DECL_NSIFILEMETADATA \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLastModified(PRInt64 *aLastModified); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIFILEMETADATA(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetSize(PRInt64 *aSize) { return _to GetSize(aSize); } \
  NS_SCRIPTABLE NS_IMETHOD GetLastModified(PRInt64 *aLastModified) { return _to GetLastModified(aLastModified); } 
...
#define NS_FORWARD_SAFE_NSIFILEMETADATA(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetLastModified(PRInt64 *aLastModified) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLastModified(aLastModified); } 
...
/* readonly attribute long long size; */
NS_IMETHODIMP nsFileMetadata::GetSize(PRInt64 *aSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute long long lastModified; */
NS_IMETHODIMP nsFileMetadata::GetLastModified(PRInt64 *aLastModified)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
