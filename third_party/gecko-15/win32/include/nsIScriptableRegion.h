...
class NS_NO_VTABLE NS_SCRIPTABLE nsIScriptableRegion : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRects(JSContext* cx, JS::Value *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSISCRIPTABLEREGION \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRects(JSContext* cx, JS::Value *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSISCRIPTABLEREGION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRects(JSContext* cx, JS::Value *_retval NS_OUTPARAM) { return _to GetRects(cx, _retval); } \
...
#define NS_FORWARD_SAFE_NSISCRIPTABLEREGION(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRects(JSContext* cx, JS::Value *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRects(cx, _retval); } \
...
/* [implicit_jscontext] jsval getRects (); */
NS_IMETHODIMP nsScriptableRegion::GetRects(JSContext* cx, JS::Value *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
