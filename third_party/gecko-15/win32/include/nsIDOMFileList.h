...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMFileList : public nsISupports {
 public: 
  ...
  virtual nsIDOMFile * GetItemAt(PRUint32 index) = 0;
...
#define NS_DECL_NSIDOMFILELIST \
  ...
  virtual nsIDOMFile * GetItemAt(PRUint32 index); 
...
#define NS_FORWARD_NSIDOMFILELIST(_to) \
  ...
  virtual nsIDOMFile * GetItemAt(PRUint32 index) { return _to GetItemAt(index); } 
...
#define NS_FORWARD_SAFE_NSIDOMFILELIST(_to) \
  ...
  virtual nsIDOMFile * GetItemAt(PRUint32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItemAt(index); } 
...
/* [noscript,nostdcall,notxpcom] nsIDOMFile getItemAt (in unsigned long index); */
nsIDOMFile * nsDOMFileList::GetItemAt(PRUint32 index)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
