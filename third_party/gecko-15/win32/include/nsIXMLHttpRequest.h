...
#define NS_IXMLHTTPREQUEST_IID_STR "8681ffbc-4755-45de-9fc1-b63e6930e76a"

#define NS_IXMLHTTPREQUEST_IID \
  {0x8681ffbc, 0x4755, 0x45de, \
    { 0x9f, 0xc1, 0xb6, 0x3e, 0x69, 0x30, 0xe7, 0x6a }}
...
class NS_SCRIPTABLE nsIXMLHttpRequest : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Send(nsIVariant *body, JSContext* cx) = 0;

  /* [implicit_jscontext] void sendAsBinary (in DOMString body); */
  NS_SCRIPTABLE NS_IMETHOD SendAsBinary(const nsAString & body, JSContext* cx) = 0;
...
#define NS_DECL_NSIXMLHTTPREQUEST \
  ...
  NS_SCRIPTABLE NS_IMETHOD Send(nsIVariant *body, JSContext* cx); \
  NS_SCRIPTABLE NS_IMETHOD SendAsBinary(const nsAString & body, JSContext* cx); \
...
#define NS_FORWARD_NSIXMLHTTPREQUEST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Send(nsIVariant *body, JSContext* cx) { return _to Send(body, cx); } \
  NS_SCRIPTABLE NS_IMETHOD SendAsBinary(const nsAString & body, JSContext* cx) { return _to SendAsBinary(body, cx); } \
...
#define NS_FORWARD_SAFE_NSIXMLHTTPREQUEST(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Send(nsIVariant *body, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->Send(body, cx); } \
  NS_SCRIPTABLE NS_IMETHOD SendAsBinary(const nsAString & body, JSContext* cx) { return !_to ? NS_ERROR_NULL_POINTER : _to->SendAsBinary(body, cx); } \
...
/* [implicit_jscontext] void send ([optional] in nsIVariant body); */
NS_IMETHODIMP nsXMLHttpRequest::Send(nsIVariant *body, JSContext* cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [implicit_jscontext] void sendAsBinary (in DOMString body); */
NS_IMETHODIMP nsXMLHttpRequest::SendAsBinary(const nsAString & body, JSContext* cx)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
