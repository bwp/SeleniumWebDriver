...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWinAppHelper : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetUserCanElevate(bool *aUserCanElevate) = 0;
...
#define NS_DECL_NSIWINAPPHELPER \
  NS_SCRIPTABLE NS_IMETHOD GetUserCanElevate(bool *aUserCanElevate); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWINAPPHELPER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetUserCanElevate(bool *aUserCanElevate) { return _to GetUserCanElevate(aUserCanElevate); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWINAPPHELPER(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetUserCanElevate(bool *aUserCanElevate) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUserCanElevate(aUserCanElevate); } 
