...
class NS_NO_VTABLE NS_SCRIPTABLE nsIWindowsRegKey : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD HasChild(const nsAString & name, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD HasValue(const nsAString & name, bool *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD StartWatching(bool recurse) = 0;

  /* void stopWatching (); */
  NS_SCRIPTABLE NS_IMETHOD StopWatching(void) = 0;

  /* boolean isWatching (); */
  NS_SCRIPTABLE NS_IMETHOD IsWatching(bool *_retval NS_OUTPARAM) = 0;

  /* boolean hasChanged (); */
  NS_SCRIPTABLE NS_IMETHOD HasChanged(bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIWINDOWSREGKEY \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasChild(const nsAString & name, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasValue(const nsAString & name, bool *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD StartWatching(bool recurse); \
  NS_SCRIPTABLE NS_IMETHOD StopWatching(void); \
  NS_SCRIPTABLE NS_IMETHOD IsWatching(bool *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD HasChanged(bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIWINDOWSREGKEY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasChild(const nsAString & name, bool *_retval NS_OUTPARAM) { return _to HasChild(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasValue(const nsAString & name, bool *_retval NS_OUTPARAM) { return _to HasValue(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD StartWatching(bool recurse) { return _to StartWatching(recurse); } \
  NS_SCRIPTABLE NS_IMETHOD StopWatching(void) { return _to StopWatching(); } \
  NS_SCRIPTABLE NS_IMETHOD IsWatching(bool *_retval NS_OUTPARAM) { return _to IsWatching(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD HasChanged(bool *_retval NS_OUTPARAM) { return _to HasChanged(_retval); } 
...
#define NS_FORWARD_SAFE_NSIWINDOWSREGKEY(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasChild(const nsAString & name, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasChild(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD HasValue(const nsAString & name, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasValue(name, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD StartWatching(bool recurse) { return !_to ? NS_ERROR_NULL_POINTER : _to->StartWatching(recurse); } \
  NS_SCRIPTABLE NS_IMETHOD StopWatching(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->StopWatching(); } \
  NS_SCRIPTABLE NS_IMETHOD IsWatching(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->IsWatching(_retval); } \
  NS_SCRIPTABLE NS_IMETHOD HasChanged(bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->HasChanged(_retval); } 
...
/* boolean hasChild (in AString name); */
NS_IMETHODIMP nsWindowsRegKey::HasChild(const nsAString & name, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean hasValue (in AString name); */
NS_IMETHODIMP nsWindowsRegKey::HasValue(const nsAString & name, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* boolean isWatching (); */
NS_IMETHODIMP nsWindowsRegKey::IsWatching(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean hasChanged (); */
NS_IMETHODIMP nsWindowsRegKey::HasChanged(bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
