/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/sms/interfaces/nsIDOMNavigatorSms.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMozNavigatorSms : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMMOZNAVIGATORSMS_IID)

  /* readonly attribute nsIDOMMozSmsManager mozSms; */
  NS_SCRIPTABLE NS_IMETHOD GetMozSms(nsIDOMMozSmsManager * *aMozSms) = 0;
...
#define NS_DECL_NSIDOMMOZNAVIGATORSMS \
  NS_SCRIPTABLE NS_IMETHOD GetMozSms(nsIDOMMozSmsManager * *aMozSms); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMMOZNAVIGATORSMS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetMozSms(nsIDOMMozSmsManager * *aMozSms) { return _to GetMozSms(aMozSms); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMMOZNAVIGATORSMS(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetMozSms(nsIDOMMozSmsManager * *aMozSms) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozSms(aMozSms); } 
