/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/image/public/imgIContainer.idl
 */
...
#define IMGICONTAINER_IID_STR "ead94080-cfd6-4a3e-8353-bd45333061d2"

#define IMGICONTAINER_IID \
  {0xead94080, 0xcfd6, 0x4a3e, \
    { 0x83, 0x53, 0xbd, 0x45, 0x33, 0x30, 0x61, 0xd2 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE imgIContainer : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetImageContainer(mozilla::layers::ImageContainer **_retval NS_OUTPARAM) = 0;
...
#define NS_FORWARD_IMGICONTAINER(_to) \
  ...
  NS_IMETHOD GetImageContainer(mozilla::layers::ImageContainer **_retval NS_OUTPARAM) { return _to GetImageContainer(_retval); } \
...
#define NS_FORWARD_SAFE_IMGICONTAINER(_to) \
  ...
  NS_IMETHOD GetImageContainer(mozilla::layers::ImageContainer **_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetImageContainer(_retval); } \
...
/* [noscript] ImageContainer getImageContainer (); */
NS_IMETHODIMP _MYCLASS_::GetImageContainer(mozilla::layers::ImageContainer **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
