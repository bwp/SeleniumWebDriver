...
#define NS_IPRINCIPAL_IID_STR "42ba6a38-d619-49ab-8248-3d247e959d5e"

#define NS_IPRINCIPAL_IID \
  {0x42ba6a38, 0xd619, 0x49ab, \
    { 0x82, 0x48, 0x3d, 0x24, 0x7e, 0x95, 0x9d, 0x5e }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPrincipal : public nsISerializable {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SubsumesIgnoringDomain(nsIPrincipal *other, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIPRINCIPAL \
  ...
  NS_SCRIPTABLE NS_IMETHOD SubsumesIgnoringDomain(nsIPrincipal *other, bool *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIPRINCIPAL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SubsumesIgnoringDomain(nsIPrincipal *other, bool *_retval NS_OUTPARAM) { return _to SubsumesIgnoringDomain(other, _retval); } \
...
#define NS_FORWARD_SAFE_NSIPRINCIPAL(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SubsumesIgnoringDomain(nsIPrincipal *other, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->SubsumesIgnoringDomain(other, _retval); } \
...
/* boolean subsumesIgnoringDomain (in nsIPrincipal other); */
NS_IMETHODIMP nsPrincipal::SubsumesIgnoringDomain(nsIPrincipal *other, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
