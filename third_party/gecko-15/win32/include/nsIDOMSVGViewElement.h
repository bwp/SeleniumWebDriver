/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/svg/nsIDOMSVGViewElement.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGViewElement : public nsIDOMSVGElement {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMSVGVIEWELEMENT_IID)

  /* readonly attribute nsIDOMSVGStringList viewTarget; */
  NS_SCRIPTABLE NS_IMETHOD GetViewTarget(nsIDOMSVGStringList * *aViewTarget) = 0;
...
#define NS_DECL_NSIDOMSVGVIEWELEMENT \
  NS_SCRIPTABLE NS_IMETHOD GetViewTarget(nsIDOMSVGStringList * *aViewTarget); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMSVGVIEWELEMENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetViewTarget(nsIDOMSVGStringList * *aViewTarget) { return _to GetViewTarget(aViewTarget); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMSVGVIEWELEMENT(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetViewTarget(nsIDOMSVGStringList * *aViewTarget) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetViewTarget(aViewTarget); } 
