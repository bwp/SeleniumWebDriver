/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/power/nsIDOMWakeLock.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMozWakeLock : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMMOZWAKELOCK_IID)

  /* readonly attribute DOMString topic; */
  NS_SCRIPTABLE NS_IMETHOD GetTopic(nsAString & aTopic) = 0;
...
#define NS_DECL_NSIDOMMOZWAKELOCK \
  NS_SCRIPTABLE NS_IMETHOD GetTopic(nsAString & aTopic); \
  NS_SCRIPTABLE NS_IMETHOD Unlock(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMMOZWAKELOCK(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetTopic(nsAString & aTopic) { return _to GetTopic(aTopic); } \
  NS_SCRIPTABLE NS_IMETHOD Unlock(void) { return _to Unlock(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMMOZWAKELOCK(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetTopic(nsAString & aTopic) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetTopic(aTopic); } \
