...
#define NS_IXPCONNECT_IID_STR "1239b432-b835-4d28-9dc0-53063cb7f60f"

#define NS_IXPCONNECT_IID \
  {0x1239b432, 0xb835, 0x4d28, \
    { 0x9d, 0xc0, 0x53, 0x06, 0x3c, 0xb7, 0xf6, 0x0f }}
...
class nsIXPConnect : public nsISupports {
 public: 
  ...
  NS_IMETHOD GarbageCollect(PRUint32 reason, PRUint32 kind) = 0;
...
#define NS_DECL_NSIXPCONNECT \
  ...
  NS_IMETHOD GarbageCollect(PRUint32 reason, PRUint32 kind); \
...
#define NS_FORWARD_NSIXPCONNECT(_to) \
  ...
  NS_IMETHOD GarbageCollect(PRUint32 reason, PRUint32 kind) { return _to GarbageCollect(reason, kind); } \
...
#define NS_FORWARD_SAFE_NSIXPCONNECT(_to) \
  ...
  NS_IMETHOD GarbageCollect(PRUint32 reason, PRUint32 kind) { return !_to ? NS_ERROR_NULL_POINTER : _to->GarbageCollect(reason, kind); } \
...
/* void GarbageCollect (in PRUint32 reason, in PRUint32 kind); */
NS_IMETHODIMP nsXPConnect::GarbageCollect(PRUint32 reason, PRUint32 kind)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
