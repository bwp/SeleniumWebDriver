...
#define NS_IAPPLICATIONCACHE_IID_STR "231e1e53-05c1-41b6-b9de-dbbcce9385c9"

#define NS_IAPPLICATIONCACHE_IID \
  {0x231e1e53, 0x05c1, 0x41b6, \
    { 0xb9, 0xde, 0xdb, 0xbc, 0xce, 0x93, 0x85, 0xc9 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIApplicationCache : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCacheDirectory(nsILocalFile * *aCacheDirectory) = 0;
...
#define NS_DECL_NSIAPPLICATIONCACHE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCacheDirectory(nsILocalFile * *aCacheDirectory); 
...
#define NS_FORWARD_NSIAPPLICATIONCACHE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCacheDirectory(nsILocalFile * *aCacheDirectory) { return _to GetCacheDirectory(aCacheDirectory); } 
...
#define NS_FORWARD_SAFE_NSIAPPLICATIONCACHE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetCacheDirectory(nsILocalFile * *aCacheDirectory) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCacheDirectory(aCacheDirectory); } 
...
/* readonly attribute nsILocalFile cacheDirectory; */
NS_IMETHODIMP nsApplicationCache::GetCacheDirectory(nsILocalFile * *aCacheDirectory)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
