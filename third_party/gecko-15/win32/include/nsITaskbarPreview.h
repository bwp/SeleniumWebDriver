/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/nsITaskbarPreview.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITaskbarPreview : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetActive(bool aActive) = 0;
...
#define NS_DECL_NSITASKBARPREVIEW \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetActive(bool aActive); \
...
#define NS_FORWARD_NSITASKBARPREVIEW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetActive(bool aActive) { return _to SetActive(aActive); } \
...
#define NS_FORWARD_SAFE_NSITASKBARPREVIEW(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD SetActive(bool aActive) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetActive(aActive); } \
