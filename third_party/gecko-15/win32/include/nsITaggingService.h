...
class NS_NO_VTABLE NS_SCRIPTABLE nsITaggingService : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasTags(bool *aHasTags) = 0;
...
#define NS_DECL_NSITAGGINGSERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasTags(bool *aHasTags); 
...
#define NS_FORWARD_NSITAGGINGSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasTags(bool *aHasTags) { return _to GetHasTags(aHasTags); } 
...
#define NS_FORWARD_SAFE_NSITAGGINGSERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetHasTags(bool *aHasTags) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasTags(aHasTags); } 
