...
#define NS_IDOMSVGTEXTPATHELEMENT_IID_STR "89ffaffa-3bf5-4c6c-82b9-155bb2f33033"

#define NS_IDOMSVGTEXTPATHELEMENT_IID \
  {0x89ffaffa, 0x3bf5, 0x4c6c, \
    { 0x82, 0xb9, 0x15, 0x5b, 0xb2, 0xf3, 0x30, 0x33 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGTextPathElement : public nsIDOMSVGTextContentElement {
 public: 
  ...
  enum {
    TEXTPATH_METHODTYPE_UNKNOWN = 0U,
    TEXTPATH_METHODTYPE_ALIGN = 1U,
    TEXTPATH_METHODTYPE_STRETCH = 2U,
    TEXTPATH_SPACINGTYPE_UNKNOWN = 0U,
    TEXTPATH_SPACINGTYPE_AUTO = 1U,
    TEXTPATH_SPACINGTYPE_EXACT = 2U
  };
