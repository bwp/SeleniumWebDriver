...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGPathSegList : public nsISupports {
 public: 
  ...
  virtual nsIDOMSVGPathSeg * GetItemAt(PRUint32 index) = 0;
...
#define NS_DECL_NSIDOMSVGPATHSEGLIST \
  ...
  virtual nsIDOMSVGPathSeg * GetItemAt(PRUint32 index); \
...
#define NS_FORWARD_NSIDOMSVGPATHSEGLIST(_to) \
  ...
  virtual nsIDOMSVGPathSeg * GetItemAt(PRUint32 index) { return _to GetItemAt(index); } \
...
#define NS_FORWARD_SAFE_NSIDOMSVGPATHSEGLIST(_to) \
  ...
  virtual nsIDOMSVGPathSeg * GetItemAt(PRUint32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItemAt(index); } \
...
/* [getter,noscript,nostdcall,notxpcom] nsIDOMSVGPathSeg getItemAt (in unsigned long index); */
nsIDOMSVGPathSeg * nsDOMSVGPathSegList::GetItemAt(PRUint32 index)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
