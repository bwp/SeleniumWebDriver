...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMSVGNumberList : public nsISupports {
 public: 
  ...
  /* [getter,noscript,nostdcall,notxpcom] nsIDOMSVGNumber getItemAt (in unsigned long index); */
  virtual nsIDOMSVGNumber * GetItemAt(PRUint32 index) = 0;
...
#define NS_DECL_NSIDOMSVGNUMBERLIST \
  ...
  virtual nsIDOMSVGNumber * GetItemAt(PRUint32 index); \
...
#define NS_FORWARD_NSIDOMSVGNUMBERLIST(_to) \
  ...
  virtual nsIDOMSVGNumber * GetItemAt(PRUint32 index) { return _to GetItemAt(index); } \
...
#define NS_FORWARD_SAFE_NSIDOMSVGNUMBERLIST(_to) \
  ...
  virtual nsIDOMSVGNumber * GetItemAt(PRUint32 index) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetItemAt(index); } \
...
/* [getter,noscript,nostdcall,notxpcom] nsIDOMSVGNumber getItemAt (in unsigned long index); */
nsIDOMSVGNumber * nsDOMSVGNumberList::GetItemAt(PRUint32 index)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
