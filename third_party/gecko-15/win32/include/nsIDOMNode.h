...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMNode : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CloneNode(bool deep, PRUint8 _argc, nsIDOMNode * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMNODE \
  ...
  NS_SCRIPTABLE NS_IMETHOD CloneNode(bool deep, PRUint8 _argc, nsIDOMNode * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIDOMNODE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CloneNode(bool deep, PRUint8 _argc, nsIDOMNode * *_retval NS_OUTPARAM) { return _to CloneNode(deep, _argc, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDOMNODE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CloneNode(bool deep, PRUint8 _argc, nsIDOMNode * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CloneNode(deep, _argc, _retval); } \
...
/* [optional_argc] nsIDOMNode cloneNode ([optional] in boolean deep); */
NS_IMETHODIMP nsDOMNode::CloneNode(bool deep, PRUint8 _argc, nsIDOMNode * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
