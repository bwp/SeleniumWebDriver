/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/docshell/base/nsIPrivacyTransitionObserver.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIPrivacyTransitionObserver : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IPRIVACYTRANSITIONOBSERVER_IID)

  /* void privateModeChanged (in bool enabled); */
  NS_SCRIPTABLE NS_IMETHOD PrivateModeChanged(bool enabled) = 0;
...
#define NS_DECL_NSIPRIVACYTRANSITIONOBSERVER \
  NS_SCRIPTABLE NS_IMETHOD PrivateModeChanged(bool enabled); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPRIVACYTRANSITIONOBSERVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD PrivateModeChanged(bool enabled) { return _to PrivateModeChanged(enabled); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPRIVACYTRANSITIONOBSERVER(_to) \
  NS_SCRIPTABLE NS_IMETHOD PrivateModeChanged(bool enabled) { return !_to ? NS_ERROR_NULL_POINTER : _to->PrivateModeChanged(enabled); } 
