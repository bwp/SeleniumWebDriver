...
#define NS_IDOMRANGE_IID_STR "a059eea8-fece-4c14-93d3-7f50a944ae43"

#define NS_IDOMRANGE_IID \
  {0xa059eea8, 0xfece, 0x4c14, \
    { 0x93, 0xd3, 0x7f, 0x50, 0xa9, 0x44, 0xae, 0x43 }}
...
/* nsIDOMDocumentFragment createContextualFragment (in DOMString fragment); */
NS_IMETHODIMP nsDOMRange::CreateContextualFragment(const nsAString & fragment, nsIDOMDocumentFragment * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* boolean isPointInRange (in nsIDOMNode parent, in long offset); */
NS_IMETHODIMP nsDOMRange::IsPointInRange(nsIDOMNode *parent, PRInt32 offset, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* short comparePoint (in nsIDOMNode parent, in long offset); */
NS_IMETHODIMP nsDOMRange::ComparePoint(nsIDOMNode *parent, PRInt32 offset, PRInt16 *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMClientRectList getClientRects (); */
NS_IMETHODIMP nsDOMRange::GetClientRects(nsIDOMClientRectList * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMClientRect getBoundingClientRect (); */
NS_IMETHODIMP nsDOMRange::GetBoundingClientRect(nsIDOMClientRect * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
