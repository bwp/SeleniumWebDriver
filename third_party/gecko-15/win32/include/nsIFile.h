...
class NS_NO_VTABLE NS_SCRIPTABLE nsIFile : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD InitWithFile(nsIFile *aFile) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRelativeDescriptor(nsIFile *fromFile, nsACString & _retval NS_OUTPARAM) = 0;

  /* void setRelativeDescriptor (in nsIFile fromFile, in ACString relativeDesc); */
  NS_SCRIPTABLE NS_IMETHOD SetRelativeDescriptor(nsIFile *fromFile, const nsACString & relativeDesc) = 0;
...
#define NS_DECL_NSIFILE \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitWithFile(nsIFile *aFile); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRelativeDescriptor(nsIFile *fromFile, nsACString & _retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD SetRelativeDescriptor(nsIFile *fromFile, const nsACString & relativeDesc); 
...
#define NS_FORWARD_NSIFILE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitWithFile(nsIFile *aFile) { return _to InitWithFile(aFile); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRelativeDescriptor(nsIFile *fromFile, nsACString & _retval NS_OUTPARAM) { return _to GetRelativeDescriptor(fromFile, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetRelativeDescriptor(nsIFile *fromFile, const nsACString & relativeDesc) { return _to SetRelativeDescriptor(fromFile, relativeDesc); } 
...
#define NS_FORWARD_SAFE_NSIFILE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD InitWithFile(nsIFile *aFile) { return !_to ? NS_ERROR_NULL_POINTER : _to->InitWithFile(aFile); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetRelativeDescriptor(nsIFile *fromFile, nsACString & _retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetRelativeDescriptor(fromFile, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD SetRelativeDescriptor(nsIFile *fromFile, const nsACString & relativeDesc) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetRelativeDescriptor(fromFile, relativeDesc); } 
...
/* [noscript] PRFileDescStar openNSPRFileDesc (in long flags, in long mode); */
NS_IMETHODIMP nsFile::OpenNSPRFileDesc(PRInt32 flags, PRInt32 mode, PRFileDesc **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [noscript] FILE openANSIFileDesc (in string mode); */
NS_IMETHODIMP nsFile::OpenANSIFileDesc(const char * mode, FILE **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* [noscript] PRLibraryStar load (); */
NS_IMETHODIMP nsFile::Load(PRLibrary **_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* readonly attribute PRInt64 diskSpaceAvailable; */
NS_IMETHODIMP nsFile::GetDiskSpaceAvailable(PRInt64 *aDiskSpaceAvailable)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* ACString getRelativeDescriptor (in nsIFile fromFile); */
NS_IMETHODIMP nsFile::GetRelativeDescriptor(nsIFile *fromFile, nsACString & _retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
