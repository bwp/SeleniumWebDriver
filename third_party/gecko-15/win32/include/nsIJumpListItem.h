/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/nsIJumpListItem.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJumpListItem : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIJumpListItem *item, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIJUMPLISTITEM \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIJumpListItem *item, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIJUMPLISTITEM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIJumpListItem *item, bool *_retval NS_OUTPARAM) { return _to Equals(item, _retval); } 
...
#define NS_FORWARD_SAFE_NSIJUMPLISTITEM(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Equals(nsIJumpListItem *item, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(item, _retval); } 
...
/* boolean equals (in nsIJumpListItem item); */
NS_IMETHODIMP nsJumpListItem::Equals(nsIJumpListItem *item, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIJumpListLink : public nsIJumpListItem {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD CompareHash(nsIURI *uri, bool *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIJUMPLISTLINK \
  ...
  NS_SCRIPTABLE NS_IMETHOD CompareHash(nsIURI *uri, bool *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIJUMPLISTLINK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CompareHash(nsIURI *uri, bool *_retval NS_OUTPARAM) { return _to CompareHash(uri, _retval); } 
...
#define NS_FORWARD_SAFE_NSIJUMPLISTLINK(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CompareHash(nsIURI *uri, bool *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CompareHash(uri, _retval); } 
...
/* boolean compareHash (in nsIURI uri); */
NS_IMETHODIMP nsJumpListLink::CompareHash(nsIURI *uri, bool *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
