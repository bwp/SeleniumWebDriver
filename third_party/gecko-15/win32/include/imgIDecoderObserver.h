/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/image/public/imgIDecoderObserver.idl
 */
...
#define IMGIDECODEROBSERVER_IID_STR "5ca71b89-1a2f-475f-881d-d76c1531c4c8"

#define IMGIDECODEROBSERVER_IID \
  {0x5ca71b89, 0x1a2f, 0x475f, \
    { 0x88, 0x1d, 0xd7, 0x6c, 0x15, 0x31, 0xc4, 0xc8 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE imgIDecoderObserver : public imgIContainerObserver {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD OnImageIsAnimated(imgIRequest *aRequest) = 0;
...
#define NS_DECL_IMGIDECODEROBSERVER \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnImageIsAnimated(imgIRequest *aRequest); \
...
#define NS_FORWARD_IMGIDECODEROBSERVER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnImageIsAnimated(imgIRequest *aRequest) { return _to OnImageIsAnimated(aRequest); } \
...
#define NS_FORWARD_SAFE_IMGIDECODEROBSERVER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD OnImageIsAnimated(imgIRequest *aRequest) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnImageIsAnimated(aRequest); } \
...
/* void onImageIsAnimated (in imgIRequest aRequest); */
NS_IMETHODIMP _MYCLASS_::OnImageIsAnimated(imgIRequest *aRequest)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
