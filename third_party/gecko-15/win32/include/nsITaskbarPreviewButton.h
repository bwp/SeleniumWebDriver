/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/nsITaskbarPreviewButton.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITaskbarPreviewButton : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDismissOnClick(bool *aDismissOnClick) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetDismissOnClick(bool aDismissOnClick) = 0;

  /* attribute boolean hasBorder; */
  NS_SCRIPTABLE NS_IMETHOD GetHasBorder(bool *aHasBorder) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetHasBorder(bool aHasBorder) = 0;
...
#define NS_DECL_NSITASKBARPREVIEWBUTTON \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDismissOnClick(bool *aDismissOnClick); \
  NS_SCRIPTABLE NS_IMETHOD SetDismissOnClick(bool aDismissOnClick); \
  NS_SCRIPTABLE NS_IMETHOD GetHasBorder(bool *aHasBorder); \
  NS_SCRIPTABLE NS_IMETHOD SetHasBorder(bool aHasBorder); \
...
#define NS_FORWARD_NSITASKBARPREVIEWBUTTON(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDismissOnClick(bool *aDismissOnClick) { return _to GetDismissOnClick(aDismissOnClick); } \
  NS_SCRIPTABLE NS_IMETHOD SetDismissOnClick(bool aDismissOnClick) { return _to SetDismissOnClick(aDismissOnClick); } \
  NS_SCRIPTABLE NS_IMETHOD GetHasBorder(bool *aHasBorder) { return _to GetHasBorder(aHasBorder); } \
  NS_SCRIPTABLE NS_IMETHOD SetHasBorder(bool aHasBorder) { return _to SetHasBorder(aHasBorder); } \
...
#define NS_FORWARD_SAFE_NSITASKBARPREVIEWBUTTON(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetDismissOnClick(bool *aDismissOnClick) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetDismissOnClick(aDismissOnClick); } \
  NS_SCRIPTABLE NS_IMETHOD SetDismissOnClick(bool aDismissOnClick) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetDismissOnClick(aDismissOnClick); } \
  NS_SCRIPTABLE NS_IMETHOD GetHasBorder(bool *aHasBorder) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetHasBorder(aHasBorder); } \
  NS_SCRIPTABLE NS_IMETHOD SetHasBorder(bool aHasBorder) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetHasBorder(aHasBorder); } \
