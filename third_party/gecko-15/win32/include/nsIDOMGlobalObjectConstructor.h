/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/base/nsIDOMGlobalObjectConstructor.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMGlobalObjectConstructor : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMGLOBALOBJECTCONSTRUCTOR_IID)

  /* void constructor (); */
  NS_SCRIPTABLE NS_IMETHOD Constructor(void) = 0;
...
#define NS_DECL_NSIDOMGLOBALOBJECTCONSTRUCTOR \
  NS_SCRIPTABLE NS_IMETHOD Constructor(void); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMGLOBALOBJECTCONSTRUCTOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD Constructor(void) { return _to Constructor(); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMGLOBALOBJECTCONSTRUCTOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD Constructor(void) { return !_to ? NS_ERROR_NULL_POINTER : _to->Constructor(); } 
