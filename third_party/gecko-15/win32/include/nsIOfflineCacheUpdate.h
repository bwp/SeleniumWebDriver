...
#define NS_IOFFLINECACHEUPDATE_IID_STR "2fa574b8-ae62-426b-be95-08e6aa957455"

#define NS_IOFFLINECACHEUPDATE_IID \
  {0x2fa574b8, 0xae62, 0x426b, \
    { 0xbe, 0x95, 0x08, 0xe6, 0xaa, 0x95, 0x74, 0x55 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIOfflineCacheUpdate : public nsISupports {
 public: 
  ...
  /* void init (in nsIURI aManifestURI, in nsIURI aDocumentURI, in nsIDOMDocument aDocument, [optional] in nsILocalFile aCustomProfileDir); */
  NS_SCRIPTABLE NS_IMETHOD Init(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIDOMDocument *aDocument, nsILocalFile *aCustomProfileDir) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetByteProgress(PRUint64 *aByteProgress) = 0;
...
#define NS_DECL_NSIOFFLINECACHEUPDATE \
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIDOMDocument *aDocument, nsILocalFile *aCustomProfileDir); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetByteProgress(PRUint64 *aByteProgress); 
...
#define NS_FORWARD_NSIOFFLINECACHEUPDATE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIDOMDocument *aDocument, nsILocalFile *aCustomProfileDir) { return _to Init(aManifestURI, aDocumentURI, aDocument, aCustomProfileDir); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetByteProgress(PRUint64 *aByteProgress) { return _to GetByteProgress(aByteProgress); } 
...
#define NS_FORWARD_SAFE_NSIOFFLINECACHEUPDATE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Init(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIDOMDocument *aDocument, nsILocalFile *aCustomProfileDir) { return !_to ? NS_ERROR_NULL_POINTER : _to->Init(aManifestURI, aDocumentURI, aDocument, aCustomProfileDir); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetByteProgress(PRUint64 *aByteProgress) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetByteProgress(aByteProgress); } 
...
/* void init (in nsIURI aManifestURI, in nsIURI aDocumentURI, in nsIDOMDocument aDocument, [optional] in nsILocalFile aCustomProfileDir); */
NS_IMETHODIMP nsOfflineCacheUpdate::Init(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsIDOMDocument *aDocument, nsILocalFile *aCustomProfileDir)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* readonly attribute PRUint64 byteProgress; */
NS_IMETHODIMP nsOfflineCacheUpdate::GetByteProgress(PRUint64 *aByteProgress)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
#define NS_IOFFLINECACHEUPDATESERVICE_IID_STR "dc5de18c-197c-41d2-9584-dd7ac7494611"

#define NS_IOFFLINECACHEUPDATESERVICE_IID \
  {0xdc5de18c, 0x197c, 0x41d2, \
    { 0x95, 0x84, 0xdd, 0x7a, 0xc7, 0x49, 0x46, 0x11 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIOfflineCacheUpdateService : public nsISupports {
 public: 
  ...
  /* nsIOfflineCacheUpdate scheduleCustomProfileUpdate (in nsIURI aManifestURI, in nsIURI aDocumentURI, in nsILocalFile aProfileDir); */
  NS_SCRIPTABLE NS_IMETHOD ScheduleCustomProfileUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsILocalFile *aProfileDir, nsIOfflineCacheUpdate * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIOFFLINECACHEUPDATESERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScheduleCustomProfileUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsILocalFile *aProfileDir, nsIOfflineCacheUpdate * *_retval NS_OUTPARAM); \
...
#define NS_FORWARD_NSIOFFLINECACHEUPDATESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScheduleCustomProfileUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsILocalFile *aProfileDir, nsIOfflineCacheUpdate * *_retval NS_OUTPARAM) { return _to ScheduleCustomProfileUpdate(aManifestURI, aDocumentURI, aProfileDir, _retval); } \
...
#define NS_FORWARD_SAFE_NSIOFFLINECACHEUPDATESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScheduleCustomProfileUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsILocalFile *aProfileDir, nsIOfflineCacheUpdate * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScheduleCustomProfileUpdate(aManifestURI, aDocumentURI, aProfileDir, _retval); } \
...
/* nsIOfflineCacheUpdate scheduleCustomProfileUpdate (in nsIURI aManifestURI, in nsIURI aDocumentURI, in nsILocalFile aProfileDir); */
NS_IMETHODIMP nsOfflineCacheUpdateService::ScheduleCustomProfileUpdate(nsIURI *aManifestURI, nsIURI *aDocumentURI, nsILocalFile *aProfileDir, nsIOfflineCacheUpdate * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
