...
#define NS_IACCESSIBLE_IID_STR "45ce2c92-4d92-49d2-bff1-855934443261"

#define NS_IACCESSIBLE_IID \
  {0x45ce2c92, 0x4d92, 0x49d2, \
    { 0xbf, 0xf1, 0x85, 0x59, 0x34, 0x44, 0x32, 0x61 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIAccessible : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD GetActionCount(PRUint8 *aActionCount) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD ScrollToPoint(PRUint32 coordinateType, PRInt32 x, PRInt32 y) = 0;
...
#define NS_DECL_NSIACCESSIBLE \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetActionCount(PRUint8 *aActionCount); \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScrollToPoint(PRUint32 coordinateType, PRInt32 x, PRInt32 y); \
...
#define NS_FORWARD_NSIACCESSIBLE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetActionCount(PRUint8 *aActionCount) { return _to GetActionCount(aActionCount); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScrollToPoint(PRUint32 coordinateType, PRInt32 x, PRInt32 y) { return _to ScrollToPoint(coordinateType, x, y); } \
...
#define NS_FORWARD_SAFE_NSIACCESSIBLE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetActionCount(PRUint8 *aActionCount) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetActionCount(aActionCount); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD ScrollToPoint(PRUint32 coordinateType, PRInt32 x, PRInt32 y) { return !_to ? NS_ERROR_NULL_POINTER : _to->ScrollToPoint(coordinateType, x, y); } \
...
/* readonly attribute PRUint8 actionCount; */
NS_IMETHODIMP nsAccessible::GetActionCount(PRUint8 *aActionCount)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void scrollTo (in unsigned long aScrollType); */
NS_IMETHODIMP nsAccessible::ScrollTo(PRUint32 aScrollType)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* void scrollToPoint (in unsigned long coordinateType, in long x, in long y); */
NS_IMETHODIMP nsAccessible::ScrollToPoint(PRUint32 coordinateType, PRInt32 x, PRInt32 y)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
