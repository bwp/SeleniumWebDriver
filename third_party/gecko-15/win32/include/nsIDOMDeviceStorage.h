...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMDeviceStorage : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Enumerate(const nsAString & directory, nsIDOMDeviceStorageCursor * *_retval NS_OUTPARAM) = 0;

  /* nsIDOMDeviceStorageCursor enumerateEditable ([optional] in DOMString directory); */
  NS_SCRIPTABLE NS_IMETHOD EnumerateEditable(const nsAString & directory, nsIDOMDeviceStorageCursor * *_retval NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIDOMDEVICESTORAGE \
  ...
  NS_SCRIPTABLE NS_IMETHOD Enumerate(const nsAString & directory, nsIDOMDeviceStorageCursor * *_retval NS_OUTPARAM); \
  NS_SCRIPTABLE NS_IMETHOD EnumerateEditable(const nsAString & directory, nsIDOMDeviceStorageCursor * *_retval NS_OUTPARAM); 
...
#define NS_FORWARD_NSIDOMDEVICESTORAGE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Enumerate(const nsAString & directory, nsIDOMDeviceStorageCursor * *_retval NS_OUTPARAM) { return _to Enumerate(directory, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD EnumerateEditable(const nsAString & directory, nsIDOMDeviceStorageCursor * *_retval NS_OUTPARAM) { return _to EnumerateEditable(directory, _retval); } 
...
#define NS_FORWARD_SAFE_NSIDOMDEVICESTORAGE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD Enumerate(const nsAString & directory, nsIDOMDeviceStorageCursor * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->Enumerate(directory, _retval); } \
  NS_SCRIPTABLE NS_IMETHOD EnumerateEditable(const nsAString & directory, nsIDOMDeviceStorageCursor * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->EnumerateEditable(directory, _retval); } 
...
/* nsIDOMDeviceStorageCursor enumerate ([optional] in DOMString directory); */
NS_IMETHODIMP nsDOMDeviceStorage::Enumerate(const nsAString & directory, nsIDOMDeviceStorageCursor * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* nsIDOMDeviceStorageCursor enumerateEditable ([optional] in DOMString directory); */
NS_IMETHODIMP nsDOMDeviceStorage::EnumerateEditable(const nsAString & directory, nsIDOMDeviceStorageCursor * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
