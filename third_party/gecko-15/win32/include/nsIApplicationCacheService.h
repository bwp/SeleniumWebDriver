...
#define NS_IAPPLICATIONCACHESERVICE_IID_STR "28adfdc7-6718-4b3e-bdb2-ecfefa3c8910"

#define NS_IAPPLICATIONCACHESERVICE_IID \
  {0x28adfdc7, 0x6718, 0x4b3e, \
    { 0xbd, 0xb2, 0xec, 0xfe, 0xfa, 0x3c, 0x89, 0x10 }}
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIApplicationCacheService : public nsISupports {
 public: 
  ...
  /* nsIApplicationCache createCustomApplicationCache (in ACString group, in nsILocalFile profileDir, in PRInt32 quota); */
  NS_SCRIPTABLE NS_IMETHOD CreateCustomApplicationCache(const nsACString & group, nsILocalFile *profileDir, PRInt32 quota, nsIApplicationCache * *_retval NS_OUTPARAM) = 0;
  ...
  NS_SCRIPTABLE NS_IMETHOD GetGroupsTimeOrdered(PRUint32 *count NS_OUTPARAM, char * **groupIDs NS_OUTPARAM) = 0;
...
#define NS_DECL_NSIAPPLICATIONCACHESERVICE \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateCustomApplicationCache(const nsACString & group, nsILocalFile *profileDir, PRInt32 quota, nsIApplicationCache * *_retval NS_OUTPARAM); \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetGroupsTimeOrdered(PRUint32 *count NS_OUTPARAM, char * **groupIDs NS_OUTPARAM); 
...
#define NS_FORWARD_NSIAPPLICATIONCACHESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateCustomApplicationCache(const nsACString & group, nsILocalFile *profileDir, PRInt32 quota, nsIApplicationCache * *_retval NS_OUTPARAM) { return _to CreateCustomApplicationCache(group, profileDir, quota, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetGroupsTimeOrdered(PRUint32 *count NS_OUTPARAM, char * **groupIDs NS_OUTPARAM) { return _to GetGroupsTimeOrdered(count, groupIDs); } 
...
#define NS_FORWARD_SAFE_NSIAPPLICATIONCACHESERVICE(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD CreateCustomApplicationCache(const nsACString & group, nsILocalFile *profileDir, PRInt32 quota, nsIApplicationCache * *_retval NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->CreateCustomApplicationCache(group, profileDir, quota, _retval); } \
  ...
  NS_SCRIPTABLE NS_IMETHOD GetGroupsTimeOrdered(PRUint32 *count NS_OUTPARAM, char * **groupIDs NS_OUTPARAM) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetGroupsTimeOrdered(count, groupIDs); } 
...
/* nsIApplicationCache createCustomApplicationCache (in ACString group, in nsILocalFile profileDir, in PRInt32 quota); */
NS_IMETHODIMP nsApplicationCacheService::CreateCustomApplicationCache(const nsACString & group, nsILocalFile *profileDir, PRInt32 quota, nsIApplicationCache * *_retval NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
...
/* void getGroupsTimeOrdered ([optional] out unsigned long count, [array, size_is (count), retval] out string groupIDs); */
NS_IMETHODIMP nsApplicationCacheService::GetGroupsTimeOrdered(PRUint32 *count NS_OUTPARAM, char * **groupIDs NS_OUTPARAM)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
