/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/interfaces/html/nsIDOMMozBrowserFrame.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMozBrowserFrame : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMMOZBROWSERFRAME_IID)

  /* attribute boolean mozbrowser; */
  NS_SCRIPTABLE NS_IMETHOD GetMozbrowser(bool *aMozbrowser) = 0;
  NS_SCRIPTABLE NS_IMETHOD SetMozbrowser(bool aMozbrowser) = 0;
...
#define NS_DECL_NSIDOMMOZBROWSERFRAME \
  NS_SCRIPTABLE NS_IMETHOD GetMozbrowser(bool *aMozbrowser); \
  NS_SCRIPTABLE NS_IMETHOD SetMozbrowser(bool aMozbrowser); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMMOZBROWSERFRAME(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetMozbrowser(bool *aMozbrowser) { return _to GetMozbrowser(aMozbrowser); } \
  NS_SCRIPTABLE NS_IMETHOD SetMozbrowser(bool aMozbrowser) { return _to SetMozbrowser(aMozbrowser); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMMOZBROWSERFRAME(_to) \
  NS_SCRIPTABLE NS_IMETHOD GetMozbrowser(bool *aMozbrowser) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetMozbrowser(aMozbrowser); } \
  NS_SCRIPTABLE NS_IMETHOD SetMozbrowser(bool aMozbrowser) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetMozbrowser(aMozbrowser); } 
