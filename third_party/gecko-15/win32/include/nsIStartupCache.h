...
class NS_NO_VTABLE nsIStartupCache : public nsISupports {
 public: 
  ...
  /* void putBuffer (in string aID, in string aBuffer, in PRUint32 aLength); */
  NS_IMETHOD PutBuffer(const char * aID, const char * aBuffer, PRUint32 aLength) = 0;
...
#define NS_DECL_NSISTARTUPCACHE \
  ...
  NS_IMETHOD PutBuffer(const char * aID, const char * aBuffer, PRUint32 aLength); \
...
#define NS_FORWARD_NSISTARTUPCACHE(_to) \
  ...
  NS_IMETHOD PutBuffer(const char * aID, const char * aBuffer, PRUint32 aLength) { return _to PutBuffer(aID, aBuffer, aLength); } \
...
#define NS_FORWARD_SAFE_NSISTARTUPCACHE(_to) \
  ...
  NS_IMETHOD PutBuffer(const char * aID, const char * aBuffer, PRUint32 aLength) { return !_to ? NS_ERROR_NULL_POINTER : _to->PutBuffer(aID, aBuffer, aLength); } \
...
/* void putBuffer (in string aID, in string aBuffer, in PRUint32 aLength); */
NS_IMETHODIMP nsStartupCache::PutBuffer(const char * aID, const char * aBuffer, PRUint32 aLength)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
