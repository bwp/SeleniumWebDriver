...
class NS_NO_VTABLE NS_SCRIPTABLE nsIINIParserWriter : public nsISupports {
 public: 
  ...
  /* void writeFile ([optional] in nsILocalFile aINIFile, [optional] in unsigned long aFlags); */
  NS_SCRIPTABLE NS_IMETHOD WriteFile(nsILocalFile *aINIFile, PRUint32 aFlags) = 0;
...
#define NS_DECL_NSIINIPARSERWRITER \
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFile(nsILocalFile *aINIFile, PRUint32 aFlags); 
...
#define NS_FORWARD_NSIINIPARSERWRITER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFile(nsILocalFile *aINIFile, PRUint32 aFlags) { return _to WriteFile(aINIFile, aFlags); } 
...
#define NS_FORWARD_SAFE_NSIINIPARSERWRITER(_to) \
  ...
  NS_SCRIPTABLE NS_IMETHOD WriteFile(nsILocalFile *aINIFile, PRUint32 aFlags) { return !_to ? NS_ERROR_NULL_POINTER : _to->WriteFile(aINIFile, aFlags); } 
...
/* void writeFile ([optional] in nsILocalFile aINIFile, [optional] in unsigned long aFlags); */
NS_IMETHODIMP nsINIParserWriter::WriteFile(nsILocalFile *aINIFile, PRUint32 aFlags)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
