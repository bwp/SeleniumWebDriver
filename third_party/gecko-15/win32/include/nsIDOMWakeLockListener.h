/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/dom/power/nsIDOMWakeLockListener.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsIDOMMozWakeLockListener : public nsISupports {
 public: 

  NS_DECLARE_STATIC_IID_ACCESSOR(NS_IDOMMOZWAKELOCKLISTENER_IID)

  /* void callback (in DOMString aTopic, in DOMString aState); */
  NS_SCRIPTABLE NS_IMETHOD Callback(const nsAString & aTopic, const nsAString & aState) = 0;
...
#define NS_DECL_NSIDOMMOZWAKELOCKLISTENER \
  NS_SCRIPTABLE NS_IMETHOD Callback(const nsAString & aTopic, const nsAString & aState); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIDOMMOZWAKELOCKLISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Callback(const nsAString & aTopic, const nsAString & aState) { return _to Callback(aTopic, aState); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIDOMMOZWAKELOCKLISTENER(_to) \
  NS_SCRIPTABLE NS_IMETHOD Callback(const nsAString & aTopic, const nsAString & aState) { return !_to ? NS_ERROR_NULL_POINTER : _to->Callback(aTopic, aState); } 
