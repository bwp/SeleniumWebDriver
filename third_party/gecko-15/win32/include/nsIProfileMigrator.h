...
class NS_NO_VTABLE NS_SCRIPTABLE nsIProfileMigrator : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD Migrate(nsIProfileStartup *aStartup, const nsACString & aKey) = 0;
...
#define NS_DECL_NSIPROFILEMIGRATOR \
  NS_SCRIPTABLE NS_IMETHOD Migrate(nsIProfileStartup *aStartup, const nsACString & aKey); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIPROFILEMIGRATOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD Migrate(nsIProfileStartup *aStartup, const nsACString & aKey) { return _to Migrate(aStartup, aKey); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIPROFILEMIGRATOR(_to) \
  NS_SCRIPTABLE NS_IMETHOD Migrate(nsIProfileStartup *aStartup, const nsACString & aKey) { return !_to ? NS_ERROR_NULL_POINTER : _to->Migrate(aStartup, aKey); } 
