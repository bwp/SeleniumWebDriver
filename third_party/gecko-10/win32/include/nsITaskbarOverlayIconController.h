/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM e:/builds/moz2_slave/rel-m-rel-xr-w32-bld/build/widget/public/nsITaskbarOverlayIconController.idl
 */
...
class NS_NO_VTABLE NS_SCRIPTABLE nsITaskbarOverlayIconController : public nsISupports {
 public: 
  ...
  NS_SCRIPTABLE NS_IMETHOD SetOverlayIcon(imgIContainer *statusIcon, const nsAString & statusDescription) = 0;
...
#define NS_DECL_NSITASKBAROVERLAYICONCONTROLLER \
  NS_SCRIPTABLE NS_IMETHOD SetOverlayIcon(imgIContainer *statusIcon, const nsAString & statusDescription); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITASKBAROVERLAYICONCONTROLLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD SetOverlayIcon(imgIContainer *statusIcon, const nsAString & statusDescription) { return _to SetOverlayIcon(statusIcon, statusDescription); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITASKBAROVERLAYICONCONTROLLER(_to) \
  NS_SCRIPTABLE NS_IMETHOD SetOverlayIcon(imgIContainer *statusIcon, const nsAString & statusDescription) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetOverlayIcon(statusIcon, statusDescription); } 
